...
public class SettledTransactionDataObject {
	...
	private String internalRequestFields;
	...
	public Object[] batchtxnSearchDownload() {
		  Object[] objectArray = new Object[22];
		  
		 
		  objectArray[0] = transactionId;
		  objectArray[1] = pgRefNum;
		  objectArray[2] = payId;
		  objectArray[3] = transactionRegion;
		  objectArray[4] = postSettledFlag;
		  objectArray[5] = txnType;
		  objectArray[6] = orderId;
		  objectArray[7] = acquirerType;
		  ...
		  objectArray[19] = internalRequestFields;
		  objectArray[20] = responseMessage;
		  objectArray[21] = pgResponseMessage;
		  return objectArray;
		}
	public String getInternalRequestFields() {
		return internalRequestFields;
	}
	public void setInternalRequestFields(String internalRequestFields) {
		this.internalRequestFields = internalRequestFields;
	}
