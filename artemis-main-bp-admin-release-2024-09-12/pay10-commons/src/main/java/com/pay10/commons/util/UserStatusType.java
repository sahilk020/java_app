...
public enum UserStatusType {
	...
	DELETED			    (109,"DELETED"),                //DELETE MERCHANT
	
	CHECKER_APPROVED    (106,"CHECKER_APPROVED"),	   // first layer approval for merchant
	OPERATION_APPROVED	(107,"OPERATION_APPROVED"),	   // second layer approval for merchant
	RISK_APPROVED		(108,"RISK_APPROVED");		  // Third layer approval for merchant
