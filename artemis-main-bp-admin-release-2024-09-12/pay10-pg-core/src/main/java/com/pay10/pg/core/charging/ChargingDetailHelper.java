...
@Service
public class ChargingDetailHelper {
	private static Logger logger = LoggerFactory.getLogger(ChargingDetailHelper.class.getName());
	@Autowired
	...
	public void addTransactionDataFields(Fields fields) throws SystemException {
		...
		String[] tdr = null;
		try {
			tdr = dao.calculateTdrAndSurcharge(payId, paymentType, acquirer, mopType, "SALE",fields.get(FieldType.CURRENCY_CODE.getName()),
