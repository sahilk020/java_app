...
public class DirecpayTransformer {
	...
	public DirecpayTransformer(Transaction transaction) {
	...
	public void updateResponse(Fields fields) {
...

		{
			...
			if ((StringUtils.isNotBlank(transaction.getResponse_Err_Code()))
				...
				DirecpayResultType resultInstance = DirecpayResultType.getInstanceFromName(transaction.getResponse_Err_Code());
