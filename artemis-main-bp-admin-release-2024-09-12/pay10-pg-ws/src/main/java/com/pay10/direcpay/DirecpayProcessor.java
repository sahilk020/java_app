...
@Service("direcpayProcessor")
public class DirecpayProcessor implements Processor {

	@Autowired
	private DirecpayIntegrator direcpayIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.DIRECPAY.getCode())) {
			return;
		}
		...
		direcpayIntegrator.process(fields);
