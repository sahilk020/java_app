...
@Service("pinelabsProcessor")
public class PinelabsProcessor implements Processor {

	@Autowired
	private PinelabsIntegrator pinelabsIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.PINELABS.getCode())) {
			return;
		}
		pinelabsIntegrator.process(fields);
	}
