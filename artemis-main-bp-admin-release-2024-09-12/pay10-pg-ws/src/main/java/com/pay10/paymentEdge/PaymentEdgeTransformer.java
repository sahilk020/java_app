...
@Service
public class PaymentEdgeTransformer {

	private static Logger logger = LoggerFactory.getLogger(PaymentEdgeTransformer.class.getName());
	
	private Transaction transaction = null;

	public PaymentEdgeTransformer(Transaction transaction) {
	...
	public void updateResponse(Fields fields) {
		...
		if ((StringUtils.isNotBlank(transaction.getResponseCode())) && (StringUtils.isNotBlank(transaction.getResponseCode()))
			...
			if ((StringUtils.isNotBlank(transaction.getResponseCode()))) {
				...
				PaymentEdgeResultType resultInstance = PaymentEdgeResultType.getInstanceFromName(respCode);
	...
	public void updateRefundResponse(Fields fields) {
...

		{
			...
			if ((StringUtils.isNotBlank(transaction.getResponseCode()))) {
				...
				PaymentEdgeRefundResultType resultInstance = PaymentEdgeRefundResultType.getInstanceFromName(respCode);
