...
public enum DemoMopType {
	...
	private DemoMopType(String bankName, String code, String bankCode){
	...
	public static DemoMopType getInstance(String name){
		DemoMopType[] mopTypes = DemoMopType.values();
		for(DemoMopType mopType : mopTypes){
	...
	public static List<DemoMopType> getGetMopsFromSystemProp(String mopsList){

		List<String> mopStringList= (List<String>) Helper.parseFields(PropertiesManager.propertiesMap.get(mopsList));

		List<DemoMopType> mops = new ArrayList<DemoMopType>();

		for(String mopCode:mopStringList){
			DemoMopType mop = getmop(mopCode);
			mops.add(mop);
		}
		return mops;
	}
	...
	public static String getmopName(String mopCode){
		DemoMopType mopType = DemoMopType.getmop(mopCode);		
		if(mopType == null) {
			return "";
		}
	...
	public static String getBankCode(String code){
		DemoMopType mopType = DemoMopType.getmop(code);		
		if(mopType == null) {
			return "";
		}
	...
	public static DemoMopType getmop(String mopCode){
		DemoMopType mopObj = null;
		if(null!=mopCode){
			for(DemoMopType mop:DemoMopType.values()){
	...
	public static DemoMopType getInstanceIgnoreCase(String name){
		DemoMopType[] mopTypes = DemoMopType.values();
		for(DemoMopType mopType : mopTypes){
