...
@Service
public class DemoStatusEnquiryProcessor {
	...
	private static Logger logger = LoggerFactory.getLogger(DemoStatusEnquiryProcessor.class.getName());
	...
	public void updateFields(Fields fields, String jsonResponse) {
		...
		demoTransformer.updateStatusResponse(fields);
