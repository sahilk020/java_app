...
@Service
public class FssSaleResponseHandler {

	private static Logger logger = LoggerFactory.getLogger(FssSaleResponseHandler.class.getName());
	...
	@Autowired
	private FssTransformer fssTransformer;
	...
	public Map<String, String> process(Fields fields) throws SystemException {
		...
		String xmlResponse = fields.get(FieldType.FSS_RESPONSE_FIELD.getName());
		...
		fields.remove(FieldType.FSS_RESPONSE_FIELD.getName());
