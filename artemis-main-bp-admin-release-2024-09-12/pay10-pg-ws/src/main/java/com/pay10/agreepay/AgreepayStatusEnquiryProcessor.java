...
@Service
public class AgreepayStatusEnquiryProcessor {
	...
	private static Logger logger = LoggerFactory.getLogger(AgreepayStatusEnquiryProcessor.class.getName());
	...
	public void updateFields(Fields fields, String jsonResponse) {
		...
		agreepayTransformer.updateStatusResponse(fields);
