...
@Service("easebuzzProcessor")
public class EasebuzzProcessor implements Processor {

	@Autowired
	private EasebuzzIntegrator easebuzzIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.EASEBUZZ.getCode())) {
			return;
		}
		easebuzzIntegrator.process(fields);
	}
