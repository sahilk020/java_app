...
import com.pay10.icici.netbanking.IciciNBIntegrator;
import com.pay10.pg.core.util.Processor;

@Service("federalNBProcess")
public class FederalBankNBProcessor implements Processor
{
	@Autowired
	private FederalBankNBIntegrator federalBankNBIntegrator;
	...
	public void process(Fields fields) throws SystemException
	{
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.NB_FEDERAL.getCode())){
			return;
		}
		...
		federalBankNBIntegrator.process(fields);
