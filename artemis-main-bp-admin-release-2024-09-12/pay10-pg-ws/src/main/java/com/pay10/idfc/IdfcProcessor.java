...
@Service("idfcProcessor")
public class IdfcProcessor implements Processor {

	@Autowired
	private idfcIntegrator idfcIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.IDFC.getCode())) {
			return;
		}

		
		idfcIntegrator.process(fields);
