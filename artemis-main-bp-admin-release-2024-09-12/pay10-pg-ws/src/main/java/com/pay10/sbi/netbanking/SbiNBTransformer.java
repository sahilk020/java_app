...
@Service
public class SbiNBTransformer {
	private static Logger logger = LoggerFactory.getLogger(SbiNBTransformer.class.getName());

	private Transaction transaction = null;

	public SbiNBTransformer(Transaction transaction) {
	...
	{   ErrorType errorType = null;
		...
		logger.info("Looking For Acquirer {} ErrorCode Mapping Status {}","SBI",transaction.getStatus());
		ErrorMappingDTO errorMappingDTO = new ErrorMappingDAOImpl().getErrorMappingByAcqCode(transaction.getStatus(), "SBI");
