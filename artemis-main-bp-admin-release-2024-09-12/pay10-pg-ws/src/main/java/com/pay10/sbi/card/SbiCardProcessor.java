...
@Service("sbiCardProcessor")
public class SbiCardProcessor implements Processor {
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.SBICARD.getCode())) {
			return;
		}
		...
		sbiCardIntegrator.process(fields);
