...
public class Constants {
	...
	public static final String REFUND_STATUS_REQUEST_URL = "CASHFREERefundStatusEnqUrl";
	...
	public static final String GENERATE_ORDER_REQUEST_URL = "CASHFREEOrderUrl";
	public static final String PAY_ORDER_REQUEST_URL = "CASHFREESaleUrl";
	public static final String RESPONSE_NOTIFY_URL = "CASHFREENotifyUrl";
