 ...
 *
 */
@Service("paytmTransactionCommunicator")
public class TransactionCommunicator {
	...
	public void updateSaleResponse(Fields fields, String request) {
		...
		fields.put(FieldType.PAYTM_FINAL_REQUEST.getName(), request.toString());
	...
	public String getResponse(String request, Fields fields) throws SystemException {
		...
		try {
			...
			case CAPTURE:
				break;
			case REFUND:
				hostUrl = PropertiesManager.propertiesMap.get(Constants.PAYTM_REFUND_URL);
				break;
			case STATUS:
			...
			logger.info("Request message to Paytm : TxnType = " + fields.get(FieldType.TXNTYPE.getName()) + " "
			...
			if ((responseData = responseReader.readLine()) != null) {
				logger.info("Paytm Refund Response >>> "+responseData);
			}
			...
			logger.error("Exception in Paytm txn Communicator", e);
		}
		return null;
