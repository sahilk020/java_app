...
@Service("paytmProcessor")
public class PaytmProcessor implements Processor {

	@Autowired
	private PaytmIntegrator paytmIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.PAYTM.getCode())) {
			return;
		}
		...
		paytmIntegrator.process(fields);
