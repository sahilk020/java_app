...
public class Constants {
	...
	public static final String PAYTEN_SALE_REQUEST_URL = "PAYTENSaleUrl";
	public static final String PAYTEN_REFUND_URL = "PAYTENRefundUrl";
	public static final String PAYTEN_STATUS_ENQ_URL = "PAYTENStatusEnqUrl";
	public static final String PAYTEN_REFUND_STATUS_ENQ_URL = "PAYTENRefundStatusEnqUrl";
	public static final String PAYTEN_RESPONSE_URL = "PAYTENReturnUrl";
