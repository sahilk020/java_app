...
public class TotalAmountOfAllTxnsActionSuperAdmin   extends AbstractSecureAction {
	...
	private static Logger logger = LoggerFactory.getLogger(TotalAmountOfAllTxnsActionSuperAdmin.class.getName());
