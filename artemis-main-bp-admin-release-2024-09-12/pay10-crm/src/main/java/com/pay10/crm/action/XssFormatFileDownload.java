...
public class XssFormatFileDownload extends AbstractSecureAction {
    ...
    public String execute() {
        ...
        try {
            logger.info("Inside MIS Report Download");
            List<MISReportObject> transactionList = new ArrayList<MISReportObject>();

            transactionList = srq.settlementReportDownloadV2(merchant, name, currency, dateFrom, dateTo);
            ...
            row.createCell(10).setCellValue("Total Acquirer Commision Amt Payable(Including GST)");
            ...
            row.createCell(20).setCellValue("Surcharge Flag");
            row.createCell(21).setCellValue("Settlement Cycle");
            row.createCell(22).setCellValue("Account Number");
            row.createCell(23).setCellValue("Reseller_Commission");
