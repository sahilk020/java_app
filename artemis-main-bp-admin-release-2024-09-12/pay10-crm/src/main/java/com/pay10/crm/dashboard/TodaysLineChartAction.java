 ...
 * Rajendra
 */
public class TodaysLineChartAction extends AbstractSecureAction {
	@Autowired
	private HourlyLineChartService getlineChartService;
	...
	private static Logger logger = LoggerFactory.getLogger(TodaysLineChartAction.class.getName());
	...
	public HourlyLineChartService getGetlineChartService() {
		return getlineChartService;
	}

	public void setGetlineChartService(HourlyLineChartService getlineChartService) {
