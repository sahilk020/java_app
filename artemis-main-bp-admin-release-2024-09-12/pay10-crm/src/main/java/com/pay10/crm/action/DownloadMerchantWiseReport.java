...
public class DownloadMerchantWiseReport extends AbstractSecureAction{
	...
	public String execute() {
				...
				logger.info("DownloadMerchantWiseReport-------- Inside Transaction Report Download");	
				List<MISReportObject> transactionList = new ArrayList<MISReportObject>();
				transactionList = transactionStatus.getMerchantWiseTransactionReport(payId, dateFrom);

				logger.info("DownloadMerchantWiseReport------------List generated successfully for Transaction Settlement Report , size = "+transactionList.size());
				...
				try {
					...
					logger.info("File generated successfully for Transaction Report");
