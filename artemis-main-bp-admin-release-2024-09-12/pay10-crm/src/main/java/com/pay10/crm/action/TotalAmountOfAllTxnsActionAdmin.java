...
public class TotalAmountOfAllTxnsActionAdmin  extends AbstractSecureAction {
	...
	private static Logger logger = LoggerFactory.getLogger(TotalAmountOfAllTxnsActionAdmin.class.getName());
...
// yenha pe ipaddress daalo and js file mein docume
			...
			if(aliasStatusList.size() == 1 && aliasStatusList.contains("Settled")) {
				...
				if (sessionUser.getUserType().equals(UserType.RESELLER)) {
					InitiatedResult = txnReports.totalAmountOfAllTxnsNew(getTransactionId(), getOrderId(), getCustomerEmail(),
							...
							getTransactionType(), getMopType(), getAcquirer(),merchantPayId, getDateFrom(), getDateTo(),
							sessionUser,"initiated",settledOnlyFlag,tenantId,getIpAddress(),getTotalAmount(),channelName,minAmount,maxAmount,columnName,logicalCondition,searchText);
				 ...
				 settledResult = txnReports.totalAmountOfAllTxnsNew(getTransactionId(),
				  ...
				  getAcquirer(),merchantPayId, getDateFrom(), getDateTo(),
				  sessionUser,"settled",settledFlag,tenantId,getIpAddress(),getTotalAmount(),channelName,minAmount,maxAmount,columnName,logicalCondition,searchText);
					...
					InitiatedResult = txnReports.totalAmountOfAllTxnsNew(getTransactionId(), getOrderId(), getCustomerEmail(),
							getCustomerPhone(), getPaymentType(), internalStatus, getCurrency(),
							getTransactionType(), getMopType(), getAcquirer(),sessionUser.getPayId(), getDateFrom(), getDateTo(),
							sessionUser,"initiated",settledOnlyFlag,tenantId,getIpAddress(),getTotalAmount(),channelName,minAmount,maxAmount,columnName,logicalCondition,searchText);
				
				 settledResult = txnReports.totalAmountOfAllTxnsNew(getTransactionId(),
				  getOrderId(), getCustomerEmail(), getCustomerPhone(), getPaymentType(),
				  "Settled", getCurrency(), getTransactionType(), getMopType(),
				  getAcquirer(),sessionUser.getPayId(), getDateFrom(), getDateTo(),
				  sessionUser,"settled",settledFlag,tenantId,getIpAddress(),getTotalAmount(),channelName,minAmount,maxAmount,columnName,logicalCondition,searchText);
					...
					InitiatedResult = txnReports.totalAmountOfAllTxnsNew(getTransactionId(), getOrderId(), getCustomerEmail(),
							getCustomerPhone(), getPaymentType(), internalStatus, getCurrency(),
							getTransactionType(), getMopType(), getAcquirer(),merchantPayId, getDateFrom(), getDateTo(), sessionUser, "initiated",settledOnlyFlag,tenantId,getIpAddress(),getTotalAmount(),channelName,minAmount,maxAmount,columnName,logicalCondition,searchText);
				  ...
				  getOrderId(), getCustomerEmail(), getCustomerPhone(), getPaymentType(),
				  "Settled", getCurrency(), getTransactionType(), getMopType(),
				  getAcquirer(),merchantPayId, getDateFrom(), getDateTo(), sessionUser, "settled",settledFlag,tenantId,getIpAddress(),getTotalAmount(),channelName,minAmount,maxAmount,columnName,logicalCondition,searchText);
