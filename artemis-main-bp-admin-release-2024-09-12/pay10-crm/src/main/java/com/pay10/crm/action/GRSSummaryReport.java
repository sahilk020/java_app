...
public class GRSSummaryReport extends AbstractSecureAction {

	
	private static final long serialVersionUID = -3306411281051464691L;
	private static Logger logger = LoggerFactory.getLogger(GRSSummaryReport.class.getName());
	@Autowired
	...
	public String execute() {
		logger.info("GRS Summary Page Executed");
