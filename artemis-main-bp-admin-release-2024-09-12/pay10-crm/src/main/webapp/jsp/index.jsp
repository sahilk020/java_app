...
<html lang="en" dir="ltr">
	...
	<head><base href="" >
		...
		<link rel="shortcut icon" href="../assets/media/images/paylogo1	.svg" />
		<!--begin::Fonts-->
                    ...
                    <div class="card my-4">
                      <div class="card-body my-3 p-lg-15 p-sm-8 p-md-8">
                          <div class="row">
							  ...
							  <span id="errorbackend">
								<s:actionmessage /></span>
                                      <!--end::Separator-->
                                      <!--begin::Input group=-->
                                      <div class="fv-row mb-2 form-group d-flex flex-column align-items-start ">
                                          <!--begin::Email-->
     ...
     <script>
			$(document).ready(function(){
				...
				if(pass!="") {
					...
					var enc=CryptoJS.AES.encrypt(pass, "thisisaverysecretkey");
					$("#password").val(enc);
					$("#errorbackend").hide();	
					$('.redvalid').hide();
