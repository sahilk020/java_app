			...
			<%-- <script src="../js/index.js"></script> --%>
				...
				<script type="text/javascript">
					...
					$(document).ready(function () {
						...
						setTimeout(function () {
							var actionMessage = $("#actionmessage")[0].innerText;
							//console.log("Mssage: "+actionMessage);
							if (actionMessage == "User details updated successfully") {
								history.go(-2);
							}
							if (responseCode) {
								if (responseCode === '000') {
														...
														<div class="col-lg-6 col-md-12 form-wrap">
															<s:form id="add_sub_merchant" class="form"
																...
																<div id="roleIdDiv">
																	...
																	<div class=" flex-column mb-8 fv-row">
																		...
																		<s:select class="form-select form-select-solid"
																			...
																			data-placeholder="Select Role" id="roleId"
																			name="roleId" list="roles" listKey="id"
																...
																<div class="text-center">
																	<button id="resetTFA" class="btn w-100  btn-primary"
																		style="margin-bottom: 10px;" type="button"
																		onclick="resetTFAuthentication()">Reset
																		2FA</button>
																</div>
