		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<!--begin::Title-->
					<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Update Application
					</h1>
					<!--end::Title-->
					<!--begin::Separator-->
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Update Application</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
							...
							<div class="row g-9 mb-8">
								...
								<div class="col-md-2"
									...
									<button type="button" class="btn btn-primary"
										onclick="updateApplication();">submit</button>
								</div>
		...
		function updateApplication() {
			...
			if (valid) {
				...
				$.ajax({
					...
					type : "POST",
					url : "updateApplicationById",
					data : data,
					success : function(response) {

							alert("Details Updated successfully");
							window.location.href =domain+"/crm/jsp/allApplication";
