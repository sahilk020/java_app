...
<title>Search Sub Super Admin</title>
...
function populateDataTable() {		
	...
	$('#searchSubSuperDataTable')
	 ...
	 $(function() {
		...
		var table = $('#searchSubSuperDataTable').DataTable();
		$('#searchSubSuperDataTable tbody')
				.on(
						'click',
						'td',
						function() {
							...
							if (columnVisible == 5) {
								...
								document.subSuperUserDetails.submit();
							}							
						});
	});
}
...
<body>
	<div id = "viewSubSuperDiv" style="overflow:scroll !important;">
	<table width="100%" align="left" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td align="left"><h2>Sub Super Admin List</h2></td>
		</tr>
		<tr>
			...
			<td align="left" style="padding: 10px;">
				<div class="scrollD">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						id="searchSubSuperDataTable" class="display">
						<thead>
	...
	<s:form name="subSuperUserDetails" action="editSubSuperAdminDetails">
