...
<script type="text/javascript">
				...
				function saveDetails(val) {
					...
					for (var i = 1; i < rowLength; i++) {
						...
						var alwaysOn = true;
						var loadPercentage = val.parentNode.children[0].children[0].rows[i].cells[10].children[0].children[0].children[0].value;
						//var priority = val.parentNode.children[0].children[0].rows[i].cells[10].innerText;
                        
						var priority = val.parentNode.children[0].children[0].rows[i].cells[11].children[0].children[0].children[0].value;
						var failedCount = val.parentNode.children[0].children[0].rows[i].cells[12].children[0].children[0].children[0].value;
						var retryMinutes = val.parentNode.children[0].children[0].rows[i].cells[13].children[0].children[0].children[0].value;
                        
						var minAmount = val.parentNode.children[0].children[0].rows[i].cells[14].children[0].children[0].children[0].value;
                        
						var maxAmount = val.parentNode.children[0].children[0].rows[i].cells[15].children[0].children[0].children[0].value;
                       
						var totalTxn = val.parentNode.children[0].children[0].rows[i].cells[16].children[0].children[0].children[0].value;
                       
						var vpaCount = val.parentNode.children[0].children[0].rows[i].cells[19].children[0].children[0].children[0].value;
                        

						if(vpaCount==null|| vpaCount==""){
							vpaCount=10
						}
					...
					if(routerType==null){
						...
						if(val.parentNode.children[0].children[0].rows[i].cells[21].children[0].children[0].children[0].value==null||val.parentNode.children[0].children[0].rows[i].cells[21].children[0].children[0].children[0].value==""){
							 routerType = val.parentNode.children[0].children[0].rows[i].cells[20].children[0].children[0].children[0].value;
					...
					if(i==1){
						 ...
						 minAmountRout = val.parentNode.children[0].children[0].rows[i].cells[17].children[0].children[0].children[0].value;
						 maxAmountRout = val.parentNode.children[0].children[0].rows[i].cells[18].children[0].children[0].children[0].value;
...
alert("please enter the TxnMixAmount")
							...
							for(j=1;j<i;j++){
								compareMax = val.parentNode.children[0].children[0].rows[j].cells[18].children[0].children[0].children[0].value;
								
								
								 compareMin = val.parentNode.children[0].children[0].rows[j].cells[17].children[0].children[0].children[0].value;
								
								 var boolmin=between(val.parentNode.children[0].children[0].rows[i].cells[17].children[0].children[0].children[0].value, compareMin, compareMax)
								
								 var boolmax=between(val.parentNode.children[0].children[0].rows[i].cells[18].children[0].children[0].children[0].value, compareMin, compareMax)
							
							var min =val.parentNode.children[0].children[0].rows[i].cells[17].children[0].children[0].children[0].value;
								
										 
							var max =val.parentNode.children[0].children[0].rows[i].cells[18].children[0].children[0].children[0].value;
						...
						var rowElement = acquirer.trim() + "," + status + "," + description.trim() + "," + mode.trim() + "," + paymentType.trim() + "," + mopType.trim() + "," + allowedFailureCount.trim() + "," + alwaysOn + "," + loadPercentage.trim() + "," + priority.trim() + "," + retryMinutes.trim() + "," + minAmount.trim() + "," + maxAmount.trim() + "," + totalTxn.trim() + "," + failedCount.trim()+","+maxAmountRout.trim()+","+minAmountRout.trim()+","+routerType.trim()+","+vpaCount;
...
.card-list-toggle {
	cursor: pointer;
	padding: 8px 12px;
	border: 1px solid #7b4ff300;
	position: relative;
	background: linear-gradient(60deg, #234b7a, #234b7a);
	color: white;
}
			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Smart Router</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
								...
								<div class="row my-3">
									<div class="col-md-12">
										...
										<s:form id="routerConfigurationForm"
											action="routerConfigurationActionMerchant" method="post">
																			...
																			<div id="<s:property value="key" />Div">
																				<table width="100%" border="0" align="center"
																					...
																					<tr class="boxheading fw-bold fs-6 text-gray-800">
																						...
																						<th width="6%" align="left" valign="middle">Payment
																							Type</th>
	...
	<script type="text/javascript">
			...
			$("#routerConfigurationForm").submit();
				...
				function enbaleButtonAsPerAccess() {
					...
					var access = accessMap["routerConfigurationAction"];
