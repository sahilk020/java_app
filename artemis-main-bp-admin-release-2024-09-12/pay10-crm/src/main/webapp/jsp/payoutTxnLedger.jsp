                  ...
                  <div class="toolbar" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                      ...
                      <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <!--begin::Title-->
                        <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Payout Txn Ledger</h1>
                        <!--end::Title-->
                        <!--begin::Separator-->
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                          ...
                          <!--end::Item-->
                          <!--begin::Item-->
                          <li class="breadcrumb-item text-muted">Payout Txn Ledger</li>
                          <!--end::Item-->
                          <!--begin::Item-->
                          <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                          ...
                          <!--end::Item-->
                          <!--begin::Item-->
                          <li class="breadcrumb-item text-dark"> Payout Txn Ledger</li>
                          <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                      </div>
                                  ...
                                  <div class="card-body ">
                                    <div class="row">
											<div class="col-lg-3 col">
												<label
													class="d-flex align-items-center fs-6 fw-semibold mb-2">Select
													Date </label><br>
												<div
													...
													<input type="text" id="reportrange" name="dateRange"
														class="form-select form-select-solid">&nbsp; <i
														class="fa fa-calendar mt-3"></i>&nbsp; <i
											...
											<div class=" col">
												<label
													...
													Id</label><br>
												<s:select name="payId" class="form-select form-select-solid"
													id="payId" headerValue="Select Merchant"
													headerKey="Select Merchant" list="payIdList" />
											</div>

											<div class="col">
												<label
													class="d-flex align-items-center fs-6 fw-semibold mb-2">Txn
													Type </label><br> <select name="txnType" id="txnType"
													class="form-select form-select-solid">
													<option>Select Txn Type</option>
													<option>Fiat</option>
											...
											<div class="col mt-2">
												<button type="button"
													class="btn btn-primary submitbtn mt-11" id="SubmitButton" onclick="javascript: renderTable();">Submit</button>
											</div>
										</div>
                                  </div>
											...
											<table id="example"
												...
												<thead>
													...
													<th>PG Ref No</th>
														...
														<th>Pay Type</th>
														<th>Account Type</th>
														<th>Account Province</th>
														<th>Account City Name</th>
														<th>Account Name</th>
														<th>Bank Branch</th>
														<th>Bank Code</th>
														<th>Create Date</th>
