...
<title>IRCTC Refund File Upload</title>
			...
			.DataTable(
					{
						...
						"ajax" : {
						"url" : domain+"/crmws/irctc/refund/search?dateFrom="+dateFrom+"&FileName="+FileName+"&pgRefNum="+pgRefNum+"&orderId="+orderId+"&canorderId="+canorderId+"&refundType="+refundType,
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Upload IRCTC Bulk
													Refund File</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
...
<a class="toggle-vis" data-column="5">RefundOrderId</a> 
															  ...
															  <a class="toggle-vis" data-column="8">Response Message</a>  
...
function saveFile(){
   ...
   $.ajax({
      url: domain+"/crmws/irctc/refund/upload/bulk",
      type: 'POST',
