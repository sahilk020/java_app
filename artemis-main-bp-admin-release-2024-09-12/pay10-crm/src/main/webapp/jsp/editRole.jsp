								...
								<div class="card-body ">
									<div class="row g-9 mb-8">
										...
										<s:form id="formValidation">
																...
																<div class="addfildn">
																	<div class="fl_wrap">
																		...
																		<s:textfield id="roleName"
																			...
																			name="roleName" maxlength="200"
																			readonly="true" type="text"
																			onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)">
																		</s:textfield>
																		<em id="roleName-error"
																	...
																	<div class="fl_wrap">
																		...
																		<div class="txtnew">
																			<s:select name="userGroupId"
																				...
																				class="form-select form-select-solid mt-3"
																				id="userGroupId" list="userGroups"
																				disabled="true" listKey="id"
																				listValue="group" autocomplete="off" />
																			<em id="userGroupId-error"
																				class="error invalid-feedback"
																				style="display: inline;"></em>
																		</div>
																	</div>
																...
																<div class="addfildn">
																	<div class="fl_wrap">
																		...
																		<s:checkbox id="isActive"
																			style="margin-top:10px;    font-weight:500; font-size:14px;"
																			name="active"
																			onclick="managePermission(this.checked);">
																		</s:checkbox>
																	</div>
																</div>
															</div>
											...
											<em id="permission-error" class="error invalid-feedback"
												style="display: inline;"></em>
																	...
																	<div class="row g-9 mb-8">
																		<div class="indent raw col-md-12 rkb">
																			<div class="addfildn row">
																				...
																				<%-- <input type="checkbox"
																					id="sub-menu-<s:property value='id' />"
																					style="margin-top: 10px; font-weight: 500; font-size: 14px;"
																					name="sub-menu-<s:property value='id' />" />
																				--%>
																				<s:iterator value="permissions">
																					<label
																						class='fl_label col-md-1 mt-6 p-0'
																						style=" font-size: 13px; font-weight: 600; ">
																						<s:property
																							value='permission' />
																					</label>
