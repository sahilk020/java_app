...
<head>
<title>Risk Refund Report</title>
<link
...
<script type="text/javascript">
								...
								.click(
										function() {
											$
													.ajax({
														url : domain
																+ "/crmws/ExceptionList/riskRefundbulkUpload",
														type : 'POST',
														headers : {
														...
														error : function(data,
															...
															if (data.responseText
																	&& JSON
																			.parse(data.responseText).respmessage) {
	...
	function Refund(id) {
		var answer = confirm("Are you sure to want to Refund?");
		if (answer != true) {
			return false;
		} else {
			$.ajax({
				url : domain + "/crmws/ExceptionList/riskRefund/" + id,
				type : 'POST',
				success : function(data) {
...
<body id="kt_body"
	...
	<div class="content d-flex flex-column flex-column-fluid"
			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Risk Refund Report</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
		...
		<div class="post d-flex flex-column-fluid" id="kt_post">
						...
						<div class="row my-5" style="text-align: center;">
							<div class="col-lg-12">
								...
								<button class="btn btn-primary btn-xs ml-2"
									style="padding: px; padding-left: 100px; padding-right: 100px;"
									id="refundBulkUpload">Refund</button>
							</div>
						</div>
			...
			<form action="DownloadRiskRefundReport" id="downloadException">
							...
							"columns" : [
									...
									},
									{
										...
										"mRender" : function(data) {
											...
											Refund = '<button class="btn btn-primary btn-xs mt-2"  name="Refund" id="Refund" onclick="Refund('
													+ data.pgRefNum
													+ ')" >Refund</button>&nbsp';
