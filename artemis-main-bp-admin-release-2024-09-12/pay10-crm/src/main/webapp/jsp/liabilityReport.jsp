			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Risk Report</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
			...
			<div id="kt_content_container" class="container-xxl">
				<div class="row my-5">
					<div class="col">
						<div class="card">
							<div class="card-body">
								<form action="downloadliabilityReport" class="box-content"
									method="post" id="DownloadliabilityReport">
									...
									<div class="row my-3 align-items-center">
										...
										<div class="col-lg-3 my-2">
											...
											</label> <select id="reportType" name="reportType"
												class="form-select form-select-solid adminMerchants">
												<option selected="selected" value="LiabilityAudit">Liability
													Audit</option>
												<option value="Hold">Hold Transaction</option>
												<!-- <option value="Release">Release Transaction</option> -->
											</select>
										</div>
									</div>
									<div class="col-lg-3 my-2">
										<button type="button" class="btn btn-primary"
											onclick="summitdetail()"
											style="padding: 2.8px 32px; margin: 1.3125rem 1px !important;">Download</button>
									</div>
								</form>
							</div>
	...
	<script type="text/javascript">
		function summitdetail() {
			...
			if (dateFrom == null || dateTo == null) {
				...
				$("#DownloadliabilityReport").submit()
			}
		}
	</script>
	<script>
