...
<html dir="ltr" lang="en-US">
	<head>
		...
		<title> Bulk Refund Search</title>
...
<script src="../assets/js/custom/utilities/modals/users-search.js"></script>
			...
			<script src="../js/jquery.select2.js" type="text/javascript"></script>
				...
				<script src="../js/bulkRefundSearch.js"></script>
...
function searchdataDownload() {
	...
	$.ajax({
		...
		type : "GET",
		url : domain+"/crmws/refund/searchRefundDownload?FromDate="+finalFromDate+"&toDate="+finalToDate+"&fileName="+fileName+"&status="+status+"",
		...
		success : function(
			...
			var responseObj = JSON
					.parse(JSON
							.stringify(response));
			if(!(responseObj.message==null)&&!(responseObj.message=="")){;
			fileLocation=responseObj.message;
			debugger
			...
			document.getElementById("downloadRefundSearch").submit();
	...
	<div class="toolbar" id="kt_toolbar">
				...
				<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
					...
					<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
						...
						<!--begin::Title-->
						<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Bulk Refund Search </h1>
						<!--end::Title-->
						<!--begin::Separator-->
						...
						<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="breadcrumb-item text-dark"> Bulk Refund Search </li>
							<!--end::Item-->
						</ul>
						<!--end::Breadcrumb-->
					</div>
	...
	<div id="kt_content_container" class="container-xxl">
	  ...
	  <div class="row my-5">
			...
			<div class="card-body ">
				...
				<s:form id="resellerPayoutForm">	
					<div class="row">
								...
								<div class="col-sm-4">
										...
										<div class="col-md-4 ">
											...
											<div class="position-relative d-flex align-items-center">
												<!--begin::Icon-->
												<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
												<input type="text" placeholder="Please enter the fileName"
										...
										<div class="col-md-4 fv-row" style="padding: 10px;">
													<label class="d-flex align-items-center fs-6 fw-semibold mb-2">
														<span class="">Status</span>
													</label>
													 <select class="form-select form-select-sm form-select-solid" id="status">
							...
							<div class="col-sm-4" style="padding: 33px;">
								<div class="txtnew">
							...
							<div class="col-sm-4" style="padding: 33px;">
								<div class="txtnew">
									<input type="button" id="submit1" value="Download" onClick="searchdataDownload()"
										class="btn btn-primary" />
								</div>
							</div>
       ...
       <div class="col">
		...
		<s:form id="downloadRefundSearch" name="downloadRefundSearch"
					action="downloadRefundSearch">
					
					<s:hidden name="fileLocation" id="fileLocation" value="" />	
				</s:form>
