...
<script type="text/javascript" src="../js/sweetalert.js"></script>
<script type="text/javascript" src="../js/offusPayout.js"></script>
			...
			<div id="kt_toolbar_container"
				...
				<!--begin::Page title-->
					<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
								...
								<!--begin::Breadcrumb-->
								<ul
									class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1" style="background-color:white;">
									<!--begin::Item-->
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-dark">Payout Rule Engine</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
				...
				<div class="table-responsive" id="onUs_default">
					...
					<div class="merchantFilter">
						...
						<s:select name="merchants" disabled="disabled"
							class="form-select form-select-solid" id="onus_merchant" listKey="payId"
					...
					<table width="100%" border="0" align="center"
						...
						<td>
							...
							<button type="button" id="onus_reset"
								class="btn btn-warning disabled">Reset</button>
						</td>
						</tr>
					</table>
				</div>
		...
		<div class="row g-9 mb-8">
			...
			<div id="offus_section">
				<div class="card-list-toggle" style="border:#234b7a; background-color: #234b7a;">
					<strong style="color: #ffffff;">Payout Rule Engine Setting</strong>
				</div>
					...
					<tr class="boxtext">
						...
						<div class="offusFormTable" id="tohide">
							<div class="merchantFilter">
								...
								<s:select name="merchants" disabled="disabled" headerKey="" headerValue="Select Merchant"
									class="form-select form-select-solid" id="offus_merchant" listKey="payId"
							...
							<table width="100%" border="0" align="center"
								...
								<tr class="boxheading">
									<th align="left" valign="middle">Acquirer</th>
									<th width="200" align="left" valign="middle">Channel</th>
								...
								<tr class="boxtext">
									...
									<td align="left" valign="top" style="width: 13%;">
										<button type="submit" id="offus_submit" style="width: 81px;"
											class="btn btn-primary disabled mb-2"
											onclick="getOffUs()">Save</button>

										<button type="button" id="offus_reset" style="width: 81px;"
...
<script>
		document.getElementById('pgCheckbox').addEventListener('change',
				function() {
					if (this.checked) {
						window.location.href = 'ruleEngine';
					}
				});
	</script>
	<%-- </s:iterator> --%>
