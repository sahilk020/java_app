<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	...
	<%@ taglib uri="/struts-tags" prefix="s" %>
		...
		<body id="kt_body"
					...
					<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
						...
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-muted">Grievance Redressal System</li>
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item"><span class="bullet bg-gray-200 w-5px h-2px"></span></li>
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-dark">GRS View</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
											...
											<div class="row my-3 align-items-center">
												<div class="col-lg-2 my-2">
													<button type="button" class="btn btn-primary" id="done"
														onclick="createGRS()">Raise Grievance</button>
												</div>
											</div>
										</div>
									</div>
			...
			<div class="modal" tabindex="-1" role="dialog" id="myModal1" style="top: 15vh; left: 5%;">
						...
						<div class="modal-body">
							<div class="row my-3 align-items-center">
								<div class="col-md-4 fv-row">
									<label style="font-weight: bold;" for="grsId">GRS Id : </label>
									<div><input type="text" id="grsId" name="grsId" value=""
								...
								<div class="col-md-4 fv-row">
									<label style="font-weight: bold;" for="merchantName">Merchant
										Name : </label>
									<div> <input type="text" id="merchantName" name="merchantName" value=""
											style="border: none; background: none; padding: 0; font-size: inherit; color: inherit;">
									</div>
								</div>
								<div class="col-md-4 fv-row">
									<label style="font-weight: bold;" for="merchantName">Title
										: </label>
									<div> <input type="text" id="title" name="title" value=""
											style="border: none; background: none; padding: 0; font-size: inherit; color: inherit;">
									</div>
								</div>
							</div>
							<div class="row my-3 align-items-center">
								<div class="col-md-4 fv-row">
									<label style="font-weight: bold;" for="merchantName">PG
										Ref Number : </label>
									<div><input type="text" id="pgRefNum" name="pgRefNum" value=""
											style="border: none; background: none; padding: 0; font-size: inherit; color: inherit;">
									</div>
								</div>
								<div class="col-md-4 fv-row">
									<label style="font-weight: bold;" for="merchantName">Customer
										Name : </label>
									<div><input type="text" id="custName" name="custName" value=""
											style="border: none; background: none; padding: 0; font-size: inherit; color: inherit;">
									</div>
								</div>
								<div class="col-md-4 fv-row">
									<label style="font-weight: bold;" for="merchantName">Last
										Updated Date : </label>
									<div><input type="text" id="updatedAt" name="updatedAt" value=""
											style="border: none; background: none; padding: 0; font-size: inherit; color: inherit;">
									</div>
								</div>
							</div>
			...
			<form action="GRSsummaryReportDownloadAction" id="downloadGRSsummaryReportAction1" method="post">
				<input id="merchants" name="merchant" type="hidden"> <input id="statuss" name="status" type="hidden">
				<input id="dateFroms" name="dateFrom" type="hidden"> <input id="dateTos" name="dateTo" type="hidden">
...

						{
							...
							"columns": [
								...
								},
								{
									...
									'render': function (data, type, full,
										meta) {
										return '<i class="fa fa-external-link" style="color: red;cursor:grab; font-size: 30px;" onclick="openGrs('
											+ "'" + data.grsId
											+ "'" + ')"/>';
									}
								}]
			...
			<script type="text/javascript">
				...
				function submitGRS() {
					$("#submitGRSSystem").prop("disabled", true);
					var grsDesc = $("#gd").val();
					...
					if (grsDesc == "" || grsDesc == null || grsDesc == undefined) {
						...
						$("#submitGRSSystem").prop("disabled", false);
						return false;
					}

					if (grsTittle == "" || grsTittle == null || grsTittle == undefined) {
						$("#documentError").text("Grievance Title is Mandatory");
						$("#submitGRSSystem").prop("disabled", false);
						return false;
					}
					...
					$.ajax({
						...
						success: function (data) {
							...
							if (data.respmessage == "Successfully Created!") {
								$("#documentError").text(data.respmessage);

							} else {
								var mess = JSON.parse(data.respmessage).Message
								var grsid = JSON.parse(data.respmessage).GRS_ID

								$("#documentError1").text("GRS " + mess + " and GRS ID " + grsid);
							}
							$("#submitGRSSystem").prop("disabled", false);
						},
						error: function (data, textStatus, jqXHR) {
				...
				function openGrs(grsId) {
					var url = new URL(window.location.href).origin
						+ "/crm/jsp/ViewGRS?grsId=" + grsId;

					window.open(url);

				}
			</script>
			<div class="modal" tabindex="-1" role="dialog" id="myModal" style="top: 30vh; left: 5%;">
				<div class="modal-dialog modal-lg" role="document"
					style="box-shadow: 2px 2px 2px 2px #f9b562 !important;">
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-body">
							...
							<span id="documentError1" class="success"></span>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-primary" id="submitGRSSystem"
