			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Exception List Report</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
							...
							<div class="card-body">
								<div class="row my-3 align-items-center">
									...
									<div class="col-md-4">
										...
										<div class="txtnew" id="fILE_NAME">
											<div id="fILE_NAME" class="wwgrp">
	<div id="fILE_NAME" class="wwctrl">
	<input type="text" name="fileName" maxlength="100" value="" id="fileName" class="form-control form-control-solid" onblur="fileName()" onkeyup="fileName()" autocomplete="off" placeholder="FileName*"></div> </div>
												...
												<div class="dropdown1">
													...
													<div class="dropdown-content1">
														<a class="toggle-vis" data-column="0">Txn Id</a> <a
															class="toggle-vis" data-column="1">RECO_TXNTYPE</a> <a
															class="toggle-vis" data-column="2">FILE_NAME</a> <a
															class="toggle-vis" data-column="3">FILE_LINE_NO</a> <a
															class="toggle-vis" data-column="4">FILE_LINE_DATA</a> <a
															class="toggle-vis" data-column="5">DB_TXN_ID</a> <a
															class="toggle-vis" data-column="6">Mop Type</a>
													</div>
												</div>
											</div>
										</div>
				...
				<form action="DownloadReportException" id="downloadException"> 
