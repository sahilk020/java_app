...
<title>Download Nodal Summary Report</title>
...
<body>
<form id="downloadSummaryReportAction" name="downloadSummaryReportAction" action="downloadNodalSummaryReportAction">
<table width="100%" align="left" cellpadding="0" cellspacing="0" class="txnf">
		<tr>
			<td align="left"><h2 style="margin-bottom:5%;">Download Nodal Summary Report</h2>
			...
			<div class="container">
								...
								<div class="form-group col-md-2 col-sm-3 col-xs-6 txtnew">
									<label for="mopType">Settlement Status</label> <br />
								 <s:select headerKey="ALL" headerValue="ALL" class="form-control"
										list="#{'Settled Only':'Settled Only','All Not Settled':'All Not Settled'}" name="settlementStatus" id = "settlementStatus" />
								</div>
