<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	...
	<%@ taglib uri="/struts-tags" prefix="s" %>
		...
		<head>
			...
			<script type="text/javascript">
				...
				function downloadReport() {
					...
					var mopType = document.getElementById("mopType").title;

					/* Added by Deep Singh code start here*/

					var channelName = document.getElementById("channelName").value ? document.getElementById
						("channelName").value : '';
				...
				$(document).ready(function () {
					...
					if (columnName == "" || columnName1 == "" || columnName2 == "") {
				...
				function totalAmountofAlltxns() {
					...
					var currency = document.getElementById("currency").value;
					//var mopType = document.getElementById("selectBox2") ? document.getElementById ("selectBox2").title : '';
					var mopType = document.getElementById("mopType").value ? document.getElementById
						("mopType").value : '';
					var acquirer = document.getElementById("selectBox1") ? document.getElementById
						("selectBox1").title : '';
				...
				function getMoptypes() {
					...
					console.log("For ALL: " + paymentType);
			...
			<script type="text/javascript">
				$(document).ready(function () {
					...
					$("#checkboxes3").change(function () {
						//console.log("change");
						var data = [];
						var mopList = $(".myCheckBox3");
						for (var i = 0; i < mopList.length; i++) {
							//console.log(mopList[i]);
							if (mopList[i].checked) {
								data.push(mopList[i].value);
								//console.log("count");
								//console.log(mopList[i].value);
							}
						}
						console.log(data);
						if (data.length > 0) {
				...
				function reloadTable() {
					...
					var colName = document.getElementById("columnName").value;
					var colName1 = document.getElementById("columnName1").value;
					var colName2 = document.getElementById("columnName2").value;
					...
					if (colName1 != "") {
						...
						var logicalCond1 = document.getElementById("logicalCondition1").value;
						var searchTxt1 = document.getElementById("searchText1").value;
					...
					if (colName2 != "") {
						...
						var logicalCond2 = document.getElementById("logicalCondition2").value;
						var searchTxt2 = document.getElementById("searchText2").value;
				...
				function generatePostData(d) {
					...
					var channelName = document.getElementById("channelName") ? document.getElementById
						("channelName").title : '';
					var minAmount = document.getElementById("minAmount").value;
					var maxAmount = document.getElementById("maxAmount").value;
					var columnName = document.getElementById("columnName").value;
	  ...
	  <div id="loader"></div>
			...
			<s:set var="needToShowAcqFieldsInReportS" value="%{#session.USER.needToShowAcqFieldsInReport}" />
			<s:set var="userType" value="%{#session.USER.UserType.name()}" />
			<s:hidden id="needToShowAcqFieldsInReport" name="needToShowAcqFieldsInReport"
						...
						<div>
							<div class="card ">
								<div class="card-header" style="display: inline-flex;padding: 1rem;">
									...
									<button style="position: relative;border: none;background: none;top: 2px;"
										id="closeBtn1"><i class="fa fa-times" aria-hidden="true"></i></button>
								</div>
								<div class="card-body ">
									<div class="row">
											...
											<ul class="nav nav-pills nav-pills-rose nav-pills-icons flex-column"
												...
												<li class="nav-item" id="listitem">
													<a class="nav-link active" data-toggle="tab" href="#link110"
														onclick="tabChangePopUp('link110')" role="tablist" id="txnInfo">
											...
											<div class="tab-content">
												<div class="tab-pane active" id="link110">
													<div class="card-header" role="tab" id="headingOne">
														<h5 class="mb-0">
															<a style="display: inline-flex;width: 100%; aria-expanded="
															...
															<div id="collapseThree" class="collapse show"
																...
																<div class="card-body">
																	<table width="100%" class="table table-responsive"
																		...
																		<tr>
																			<th align="left" valign="middle">Order ID
																			</th>
																			<th align="left" valign="middle">Transaction
																				Type</th>
														...
														<table width="100%" class="">
															<tr>
																<th height="25" colspan="4" align="left"
																	valign="middle">Card Holder Name</th>
															...
															<!--<tr class="udf6Box" style="display: none;">
																<th height="25" colspan="4" align="left"
																	valign="middle"><span>UDF6</span></th>
...
-->
															<tr>
																<th height="25" colspan="4" align="left"
																	valign="middle"><span>Acquirer Response</span></th>
												...
												<div class="tab-pane" id="link112">
																...
																<div class="card-body">
																	...
																	<table width="100%" class="">
																		<tr>
																			...
																			<th align="left" valign="middle">Phone
																				No</th>
																		...
																		<tr>
																			<th align="left" valign="middle">City
																			</th>
																			<th align="left" valign="middle">State
																			</th>
																		...
																		<tr>
																			...
																			<th align="left" valign="middle">Country
																			</th>
																			<th align="left" valign="middle">Zip
																			</th>
																		</tr>
																		<tr id="sec7">
												  ...
												  width: 100%;" data-toggle="collapse" href="#collapseTwo" aria-expanded="false"
			...
			<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
				...
				<div class="post d-flex flex-column-fluid" id="kt_post">
					<!--begin::Container-->
					<div id="kt_content_container" class="container-xxl" onclick="displayNone()">
						...
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
							...
							<!--begin::Title-->
							<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Admin Search Payments</h1>
							<!--end::Title-->
							<!--begin::Separator-->
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-dark"> Admin Search Payments</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
										...
										<div class="card-body">
											...
											<div class="row g-9 mb-8">
												<div class="col-md-4 fv-row fv-plugins-icon-container">
													...
													<label class="switch">
														<input type="checkbox" id="newDespositor">
										...
										onblur="validateCustomerEmail(this);" onKeyDown="if(event.keyCode === 32)return false;" onpaste="removeSpaces(this);"></s:textfield> -->
														...
														<div class="">
															...
															<div id="checkboxes3" onclick="getCheckBoxValue(3)">
																...
																<s:checkboxlist headerKey="ALL" headerValue="ALL"
																	...
																	value="paymentMethod" onchange="getMoptypes()" />
													...
													<div class="col-md-4 fv-row">
														...
														<!--<div class="">
															<div class="selectBox" id="selectBox2"
																onclick="showCheckboxes(event,2)" title="ALL">
																<select
																	class="form-select form-select-sm form-select-solid">
																	<option>ALL</option>
																</select>
															...
															<div id="checkboxes2" onclick="getCheckBoxValue(2)">
																...
																<s:checkboxlist name="mopType" id="mopType"
																	headerValue="ALL" headerKey="ALL"
																	list="@com.pay10.commons.util.MopTypeUI@values()"
																	listValue="name" listKey="uiName"
																	class="myCheckBox2" value="mopType" />
											...
											<div class="row g-9 mb-8">
												...
												<div class="col-md-4 fv-row">
													...
													<div class="txtnew">
														<s:textfield id="ipAddress"
															...
															onkeyup="ipAddressValidation()"></s:textfield>
													</div>
												...
												<div class="col-md-4 fv-row">
													...
													<div class="txtnew">
														<s:textfield id="rrn" class="form-control form-control-solid"
															name="rrn" type="number" value="" autocomplete="off"
															ondrop="return false;" maxlength="9" pattern="\d*"
															onkeyup="rrnValidation()"></s:textfield>
													</div>
													<span id="validRNN" style="color:red; display:none;">Please
														Enter Valid RNN.</span>
												</div>
												...
												<div class="col-md-4 fv-row">
													...
													<div class="txtnew">
														<s:textfield id="totalAmount"
															...
															ondrop="return false;" maxlength="15"></s:textfield>
													</div>
													<span id="validIpAddress" style="color:red; display:none;">Enter
														Valid Total Amount</span>
												</div>
											...
											<div class="row g-9 mb-8">
												...
												<div class="col-md-4 fv-row">
													...
													<!-- 	 <div class="" id="selectBox5" onclick="showCheckboxes(event,5)"
														title="ALL">
												...
												<div class="col-md-4 fv-row">
													...
													<span id="validSearchText" style="color:red; display:none;">Please
												...
												<div class="col-md-4 fv-row">
													...
													<span id="validSearchText1" style="color:red; display:none;">Please
														Enter Search Text.</span>
												...
												<div class="col-md-4 fv-row">
													...
													<span id="validSearchText2" style="color:red; display:none;">Please
														Enter Search Text.</span>
											...
											<div class="col-lg-4 col-sm-12 col-md-6">
												<div class="dropdown1">
													...
													<div class="dropdown-content1">
														<a class="toggle-vis" data-column="0">Txn Id</a>
														<a class="toggle-vis" data-column="1">Pg ref no</a>
														...
														<!-- <a class="toggle-vis" data-column="5">Refund Order Id</a> -->
														<s:if
															test="%{#session.USER.UserType.name() != 'SUBADMIN' || #session.USER.needToShowAcqFieldsInReport == true}">
															<a class="toggle-vis" data-column="5">Mop Type</a>
															<a class="toggle-vis" data-column="6">Payment Method</a>
														</s:if>
														<a class="toggle-vis" data-column="7">Txn Type</a>
														<a class="toggle-vis" data-column="8">Status</a>
														<a class="toggle-vis" data-column="9">Base Amount</a>
														<a class="toggle-vis" data-column="10">Total Amount</a>
														<a class="toggle-vis" data-column="11">Pay Id</a>
														<a class="toggle-vis" data-column="12">Currency</a>
														<a class="toggle-vis" data-column="13">Customer Email</a>
														<a class="toggle-vis" data-column="14">Customer Ph Number</a>

														<a class="toggle-vis" data-column="15">Acquirer Type</a>
														<a class="toggle-vis" data-column="16">Ip Address</a>
														<a class="toggle-vis" data-column="17">card Mask</a>
														<a class="toggle-vis" data-column="18">RRN Number</a>
														<a class="toggle-vis" data-column="19">Card Holder Type</a>
														<a class="toggle-vis" data-column="20">PSP NAME</a>
													...
													<table id="txnResultDataTable"
														...
														<thead>
															<tr class="fw-bold fs-6 text-gray-800">
																...
																<th class="min-w-90px">Card Holder Type</th>
																<th class="min-w-90px">PSP NAME</th>
				...
				<s:form id="downloadPaymentReport" name="downloadPaymentsReportAction"
					...
					<s:hidden name="needToShowAcquirerDetails" id="needToShowAcquirerDetails" value="" />
				</s:form>
			...
			<script type="text/javascript">
				...
				function rrnValidation() {
					var rrnNumber = $("#rrn").val();
					console.log(rrnNumber);
					if (!(/^\d{9}$/).test(rrnNumber)) {
			...
			<script type="text/javascript">
				...
				function logicalOperatorDisplay() {
					...
					if (columnName == "PG_REF_NUM" || columnName == "TXN_ID" || columnName == "REFUND_ORDER_ID" || columnName == "REFUND_FLAG" || columnName == "ACQ_ID" ||
						columnName == "CARD_MASK" || columnName == "SETTLEMENT_FLAG" || columnName == "CARD_HOLDER_TYPE" || columnName == "ORDER_ID" || columnName == "CUST_EMAIL") {
						forTextOperator();
					}
				};
