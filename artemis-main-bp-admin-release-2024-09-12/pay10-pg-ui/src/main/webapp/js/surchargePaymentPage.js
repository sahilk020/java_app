...
function getVpadata1() {
    var upid = document.getElementById('vpaCheck').value

    var psp = document.getElementById('m').value
    if (upid.includes("@")) {

        var str = upid.substring(0, upid.indexOf('@'));
        var VpaAddress = str + psp;
        document.getElementById('vpaCheck').value = VpaAddress

    } else {

        var VpaAddress = upid + psp;
...
function getVpadata(pspName) {
    document.getElementById("m").style.display = "block";

    var psp = document.getElementById('vpaCheck').value
    const myArray = pspName.split(",");

    if (pspName.includes(",")) {
        $('#m').empty();
        if (psp.includes("@")) {

            var str = psp.substring(0, psp.indexOf('@'));
            var VpaAddress = str + myArray[0];

            document.getElementById('vpaCheck').value = VpaAddress

        } else {

            var VpaAddress = psp + myArray[0];
        ...
        for (i = 0; i < myArray.length; i++) {
            ...
            document.getElementById("m").innerHTML += '<option id="' + i + '">' + myArray[i] + '</option>';
        }
        ...
        if (psp.includes("@")) {
            ...
            var str = psp.substring(0, psp.indexOf('@'));
            var VpaAddress = str + pspName;
            document.getElementById('vpaCheck').value = VpaAddress

        } else {

            var VpaAddress = psp + pspName;
...
function BackMobileView() {
    ...
    if (innerwidth < 991) {
        ...
        document.getElementById('mobileviewSecond').style.display = 'none';
    }
    else {
        document.getElementById('debitWithPin').style.display = 'block';
        document.getElementById('mobileviewFirst').style.display = 'none';
...
function showStuff(currentElement, paymentType) {
    ...
    if (innerwidth < 991) {
        ...
        document.getElementById('pricesectionmobile').style.display = 'none';
        document.getElementById('paymentSections').style.display = 'block';
        document.getElementById('mobileviewFirst').style.display = 'none';
        document.getElementById('mobileviewSecond').style.display = 'flex';
        ...
        if (paymentType == "EMI") {
            ...
            document.getElementById('iMudra').style.display = 'none';
            document.getElementById('netBanking').style.display = 'none';
            document.getElementById('emiSidebar').style.display = "block";
    ...
    switch (paymentType) {
        ...
        case "creditCard":
            ...
            document.getElementById('emiSidebar').style.display = "none";
...
function upiSubmit(upiNameProvided, upiNumberProvided, paymentType, mopType, amount, currencyCode) {
    var token = document.getElementsByName("customToken")[0].value,
        ...
        data = new FormData(),
        myMap = new Map();
    var BROWSERDEVICE = document.getElementById('BROWSERDEVICE').value;
    data.append('token', token);
    ...
    data.append('BROWSER_DEVICE', BROWSERDEVICE);
...
function pageInfo() {
    ...
    function createFingerprint(string) {
        ...
        document.getElementById('BROWSERDEVICE').value = hash;
        document.getElementById('BROWSERDEVICENB').value = hash;
        document.getElementById('BROWSERDEVICECARD').value = hash;
        document.getElementById('BROWSERDEVICEWL').value = hash;
...
//                debugger
    ...
    if (obj.upi) {
        allLi += '<li class="tabLi" id="upiLi" onclick="showStuff(this, ' + "'upi'" + ')" data-id="upi"><img src="../assets/images/Icons Background (2).svg" alt="UPI"><a>UPI</a><div class="itemarrow"><img src="../assets/images/Shape.png" alt="Item Arrow" /></div></li>';
    }
    ...
    if (obj.EMI) {
        allLi += '<li class="tabLi" id="emiLi" onclick="showStuff(this,' + "'EMI'" + ')" data-id="emi"> <img src="../assets/images/Icons Background (4).svg" alt="EMI"><a>EMI</a><div class="itemarrow"><img src="../assets/images/Shape.png" alt="Item Arrow" /></div></li>';
    }
    ...
    if (obj.EMI) {
        document.getElementById('emiLi').classList.add("activeLi");
        document.getElementById('emi').classList.remove("hideBox");
        addConvenienceFee('EMI');
        document.getElementById('orderfootDetails1').innerHTML = emiCopy;
        document.getElementById('orderfootDetails2').innerHTML = emiCopy;
        document.getElementById("loading2").style.display = "none";
        return false;
    }
...
function addConvenienceFee(paymentType) {
    ...
    var Currencycode = document.getElementById('currencyCodeMultiply').value;
    ...
    var urlString = domain + "/crmws/CurrencyNumber/decimal/";
        ...
        success: function (data, status) {
            ...
            switch (paymentType) {
                case "creditCard":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_cc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('confirm-purchase').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_cc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('exSubmit').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_cc) + Number(innerAmount)).toFixed(multiplier);
                ...
                case "debitCard":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_dc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('confirm-purchase').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_dc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('exSubmit').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_dc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('confirm-purchase').classList.add('inactive');
                ...
                case "prepaidCard":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_pc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('confirm-purchase').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_pc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('exSubmit').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_pc) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('confirm-purchase').classList.add('inactive');
                ...
                case "upi":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_up) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('upi-sbmt').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_up) + Number(innerAmount)).toFixed(multiplier);
                ...
                case "QRCODE":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_qr) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('upi-sbmt').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_qr) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('upi-sbmt').classList.add('inactive');
                ...
                case "googlePay":
                    surcharge.textContent = currencyCode + ' ' + pageInfoObj.surcharge_up;
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_up) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('googlePayBtn').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_up) + Number(innerAmount)).toFixed(multiplier);
                    break;
                case "autoDebit":
                    surcharge.textContent = currencyCode + ' ' + pageInfoObj.surcharge_ad;
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_ad) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('autoDebitBtn').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_ad) + Number(innerAmount)).toFixed(multiplier);
                ...
                case "iMudra":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_wl) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('iMudraBtn').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_wl) + Number(innerAmount)).toFixed(multiplier);
                ...
                case "netBanking":
                    ...
                    totalAmount.textContent = currencyCode + ' ' + (Number(pageInfoObj.surcharge_nb) + Number(innerAmount)).toFixed(multiplier);
                    document.getElementById('netBankingBtn').value = 'Pay ' + currencyCode + ' ' + (Number(pageInfoObj.surcharge_nb) + Number(innerAmount)).toFixed(multiplier);
                    ...
                    break;
                case "EMI":
                    surcharge.textContent = currencyCode + ' ' + 0;
                    totalAmount.textContent = currencyCode + ' ' + Number(innerAmount).toFixed(multiplier);
                    document.getElementById('emiBtn').value = 'Pay ' + currencyCode + ' ' + Number(innerAmount).toFixed(multiplier);
                    document.getElementById('emiBtn').classList.add('inactive');
                    break;
            }
...
function binCheck(event) {
    ...
    xhr.onload = function () {
        var obj = JSON.parse(this.response);
        console.log("binResolver response:", obj);
        ...
        switch (obj.paymentType) {
            case "DC":
                ...
                break;
            case "CC":
                if (obj.ccsurchargeAmount != null && obj.ccsurchargeAmount !== "") {
                    document.getElementById('ccsurchargeAmount').value = obj.ccsurchargeAmount;
                    pageInfoObj.surcharge_cc = obj.ccsurchargeAmount;
                }

                if (obj.ccsurchargeTotal != null && obj.ccsurchargeTotal !== "") {
                    document.getElementById('ccsurchargeTotal').value = obj.ccsurchargeTotal;
                }

                if (obj.internationalCard != null && obj.internationalCard !== "") {
                    pageInfoObj.internationalCard = obj.internationalCard;
                }
    ...
    if (document.getElementById('vpaCheck').classList.contains('redLine')) {
        ...
        xhttp.onload = function () {
            ...
            if (obj.status == "Success") {
                ...
                document.getElementById('upi-sbmt').style.backgroundColor = '#1842e1';
                document.getElementById("upi-sbmt").disabled = false;
...
let trStart = "<tr>";
let trEnd = "</tr>";
function showTenures(bankName) {
    if (bankName === '') {
        document.getElementById("tenureTable").style.display = "none";
        return;
    }
    document.getElementById("tenureTable").style.display = "block";
    document.getElementById("setEmiBankname").innerHTML = bankName;
    let allBankTenures = JSON.parse(document.getElementById("tenureDataAll").value);
    for (let j = 0; j < allBankTenures.length; j++) {
        if (allBankTenures[j].bank === bankName) {
            let tenuresArray = allBankTenures[j].emis;
            let tBodyData = "";
            for (let n = 0; n < tenuresArray.length; n++) {
                tBodyData += trStart + "<td scope='row'>" +
                    "<input type = 'radio' id='" + tenuresArray[n].emiId + "' name= 'tenure' value='" +
                    tenuresArray[n].tenure + "' onclick='setTenureLength(this.value)' /> </td>";

                tBodyData += "<td>" + tenuresArray[n].emiDesc + "</td>";

                tBodyData += "<td>" + tenuresArray[n].roi + "</td>";

                tBodyData += "<td>" + tenuresArray[n].emiAmount + "</td>";

                tBodyData += "<td>" + tenuresArray[n].totalInterest + "</td>";

                tBodyData += "<td>" + tenuresArray[n].principalAmount + "</td>";

                tBodyData += "<td>" + tenuresArray[n].discount + "</td>";

                tBodyData += trEnd;
            }
            document.getElementById("tenureTBody").innerHTML = tBodyData;
            break;
        }
    }
}

function setTenureLength(tenureLength) {
    if (tenureLength < 10) {
        tenureLength = "0" + tenureLength;
    }
    $("#tenureLength").val(tenureLength);
}

function submitEmi() {
    let bankName = $("#emiBankId").val();
    let tenure = $("#tenureLength").val();
    if (bankName === null || bankName === '') {
        alert("Please select bank");
        document.getElementById("emiBankId").focus();
        return false;
    }
    if (tenure === null || tenure === '') {
        alert("Please select tenures");
        document.getElementById("tenureTBody").focus();
        return false;
    }
    document.getElementById('loading2').style.display = "block";
    document.getElementById('emiBtn').classList.add("pointerEventNone");
    document.getElementById('emiBtn').disabled = true;
    document.getElementById('emiFormId').submit();
}

function clickTab(){
	$(".tabLi.activeLi").click();
}
