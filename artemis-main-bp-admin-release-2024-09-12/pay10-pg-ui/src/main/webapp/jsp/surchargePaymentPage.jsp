...
.upitext{
width: 360px !important;border-right: 0px solid #ddd !important;
}

/* Extra small devices (phones, 600px and down) */
@media only screen and (max-width: 600px) {
.upitext{
width: 181px!important;border-right: 0px solid #ddd !important;
}
}
...
function displayDefault(){
	...
	PayRegion = "<s:property value='%{#session.PAYMENTS_REGION}'/>";
    document.getElementById("PayRegion").value =PayRegion ;
...
<body class="body loader_disabled"
	OnLoad="setInterval(1); displayDefault(); pageInfo(); clickTab(); checkAquirerType(); loaderClassRemove();"
...
<div id="QRIMG"  ></div>
<div id="QRfot">
											<img src="../assets/images/Frame 32.svg" alt="BestPay Logo"style="
    margin-top: 44px;
" />
    ...
    <!-- <div class="mob-container" id="mobhome">
        <section class="mob-header">
            <div class="header-topbar mx-3 pt-3 pb-1 d-flex align-items-center justify-content-between">
                <div class="col logo-wrap d-flex align-items-center flex-fill">
                    ...
                    <div class="logo">
                        <img src="../assets/images/Mask Group.svg" alt="BestPay Logo">
                    </div>
            ...
            <div class="price-section mx-3 pt-3">
                <div class="price-wrap">
                    <div class="lists d-flex justify-content-between py-2">
                        ...
                        <div class="price">
                            <img src="../assets/images/Vector.svg" width=50px height=50px alt="Rupees">
                            <span>1650.00</span>
                        </div>
                    </div>
                    <div class="lists d-flex justify-content-between py-2">
                    ...
                    <div class="lists d-flex justify-content-between py-2">
                        <span>GST</span>
                        <div class="price">
                            <img src="../assets/images/Vector.svg"  width=50px height=50pxalt="Rupees">
                            <span>05.00</span>
                        </div>
                    </div>
                    <div class="lists d-flex justify-content-between py-2">
        ...
        <section class="mob-footer mt-5 pb-3">
            <div class="footer-wrap mx-3 pt-3 pb-1 d-flex justify-content-center">
                <img src="../assets/images/Frame 32.svg" alt="BestPay Logo" />
            </div>
        </section>
    </div> -->
						...
						<div class="col-lg-9 mobile-view-header">
							<section class="mob-header" id="mobileviewFirst">
								<div class="header-topbar mx-3 pt-3 pb-1 d-flex align-items-center justify-content-between">
									...
									%>
									<span class="logo">
										<img src="../image/new-payment-page-logo.png" alt="BestPay Logo" style="width: 219px;" title="BestPay Logo" width="77" height="47"/>
									</span>
									<%
										}
									%>
							...
							<section class="px-3 mobheader w-100 mobsection mobilesection"  id="mobileviewSecond">
								<a id="backarrow" onclick="BackMobileView();">
									<img src="../assets/images/chevron-left.svg" alt="Back Arrow" >
								</a>
								<p class="pay">Pay</p>
								<div class="values">
									<!-- <img src="../assets/images/Vector.svg"  alt="BestPay Logo"> -->
									<span id="mobileViewTotalAmount" class="value">0.00</span>
								</div>
								<div class="col logo-time d-flex justify-content-end flex-fill notranslate"><s:label name="lblSessionTimeMobile"
									id="lblSessionTimeMobilesecond"></s:label>&nbsp; min</div>
							</section>
							<div class="csls_main-header">
								<div id="header" class="clearfix">
									...
									<img src="../image/280x40.png" alt="BestPay Logo" title="BestPay Logo">
									</span> --%>
									<span class="logo">
										<img src="../image/new-payment-page-logo.png" alt="BestPay Logo" title="BestPay Logo" width="77" height="47"/>
									</span>
									<%
										}
									%>
									...
									id="cardsaveflag1" class="cardsaveflag11"/>
												...
												<div class="footer d-f f-jcb f-aic">
													<div class="left-footer">
														...
														<img src="../image/visa-foot.svg" class="visa-foot" alt="visa"
															...
															class="master-foot" alt="master" title="master" /> <a href="#" target="_blank"><img
											...
											<div class="row px-4 py-4 w-100">
												<div class="col-lg-12 ">
													...
													if (webUrl.equals("pg.zebrapay.in")) {
												%>
												<div class="copyright notranslate" style="display: none;">© 2024
													pg.zebrapay.in. All rights reserved</div>
												<%
													} else {
												%>
												<div class="copyright notranslate" style="display: none;">© 2024
													api.bpgate.net. All rights reserved</div>
												<%
													}
												%>
												</div>
									...
									<div id="upi" class="tabBox upiBox hideBox">
										...
										<div class="containers overflow-hidden upi-img d-f f-aic">
											<div class="row gy-2">
											  ...
											  <div class="border d-flex justify-content-center align-items-center border-corner">
													<img src="../assets/images/Frame 55.svg" onclick=getVpadata("@paytm") alt="Paytm">
												</div>
											  </div>
												<div class="col-4 mb-2">
											  <div class="border d-flex justify-content-center align-items-center border-corner">
													<img src="../assets/images/Frame 58.svg" onclick=getVpadata("@ybl,@ibl,@axl") alt="PhonePe">
												</div>
											  </div>
												<div class="col-4 mb-2">
											  <div class="border d-flex justify-content-center align-items-center border-corner">
													<img src="../assets/images/Frame 56.svg" onclick=getVpadata("@apl") alt="AmazonPay">
												</div>
											  </div>
												<div class="col-4 mb-2">
											  <div class="border d-flex justify-content-center align-items-center border-corner">
													<img src="../assets/images/Frame 57.svg" onclick=getVpadata("@okicici,@okaxis,@okhdfcbank,@okicici") alt="Gpay">
												</div>
											  </div>
												<div class="col-4 mb-2">
											  <div class="border d-flex justify-content-center align-items-center border-corner">
													<img src="../assets/images/image58.svg" onclick=getVpadata("@ikwik") alt="Mobikwik">
												</div>
											  </div>
												<div class="col-4 mb-2">
											  <div class="border d-flex justify-content-center align-items-center border-corner">
													<img src="../assets/images/Frame 59.svg" onclick=getVpadata("@wasbi") alt="Freecharge">
												</div>
											  </div>
											</div>
										</div>
										...
										<div class="vpaSection col-lg-12">
											<label class="col-form-label">UPI id</label>
												...
												<input type="text" class=" text-center form-control upitext" onkeyup="isValidVpa(); enableButton();getupid();"
...
<select id="m" onchange="getVpadata1()" style="margin-left: -3px;border: 2px solid #ddd;background: none;width: 13%;height: 47px;text-indent: 15px;border-left: 0px solid #ddd;box-shadow: none;font-size: 12px;display: block;margin-top: 0px;border-top: 1px solid #ddd;">

        </select>												
												<input type="button" class="payment-btn" id="m1"
												value="verify" onclick="VpaValidate()" style="background-color: #041fff;width: 30%;margin-left: 24px;">
												</div>
												<div class="resultDiv">
													<p class="red1" id="red1">Invalid VPA</p>
													<p class="" id="green1" style="color: green;display: none;font-size: 12px;">VPA Validate Successfull</p>
										...
										<div class="row px-4 py-4 w-100">
											<div class="col-lg-12 ">
												...
												if (webUrl.equals("pg.zebrapay.in")) {
											%>
											<div class="copyright" style="display: none;">© 2024
												pg.zebrapay.in. All rights reserved</div>
											<%
												} else {
											%>
									...
									<s:checkbox id="tnc" class="tnccheck"
										...
										<div class="CTA mob-btn" id="pay-now">
											...
											<input type="button" disabled style="background-color: #5c83cd;" class="payment-btn" id="upi-sbmt"
		...
		<div id="QRCODE" class="tabBox QRCODEBox hideBox">
									...
									<div id="iMudra" class="tabBox iMudraBox hideBox">
										...
										<form id="imudraFormId" name="imudraFormName" action="pay"
											...
											<input type="hidden" id="PayRegion" name="paymentsRegion" value="">
                ...
                to merchant</a> -->
									...
									<section class="mob-footer pb-3">
										<div class="footer-wrap mx-3  pb-1 d-flex justify-content-center">
                                            ...
                                            <img src="../assets/images/Frame 32.svg" id="QRFooter"
                                            style=" display: block;" alt="BestPay Logo" height="30px" width="auto" />
                                            </div>
									</section>
								...
								<div class="paymentlist px-3">
									<ul class="p-0 notranslate">
										<!-- <li class="d-flex justify-content-between py-2">
											...
											<div class="values">
												<img src="../assets/images/rupees.svg" alt="BestPay Logo">
										...
										<li class="d-flex justify-content-between py-2">
											...
											<div class="values">
<!-- 											<img src="../assets/images/rupees.svg" alt="BestPay Logo"> -->
<div id="currencyCode" style="font-size: 13px;"></div>&nbsp;
								...
								<div class="row">
								<div class="col-sm-12">
									<span class="item" id="totalAmountName" style="display:block;">You have to pay</span>
								</div>
								<div class="col-sm-12">
											...
											<div class="midSec">
												<%
													...
													try {
														...
														int points=Integer.parseInt(CurrencyNumber.getDecimalfromInstance(currencyCodeAlpha));
														String s="0.";
												...
												%>
												<input type="hidden" id="currencyCodeMultiply"
