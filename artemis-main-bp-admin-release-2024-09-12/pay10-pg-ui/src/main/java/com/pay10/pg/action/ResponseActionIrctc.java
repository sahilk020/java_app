...
public class ResponseActionIrctc extends AbstractSecureAction implements ServletRequestAware {
	...
	private static Logger logger = LoggerFactory.getLogger(ResponseActionIrctc.class.getName());
