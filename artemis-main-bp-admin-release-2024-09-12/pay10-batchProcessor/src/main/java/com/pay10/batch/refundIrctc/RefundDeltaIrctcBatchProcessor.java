...
import com.pay10.batch.BatchDeltaIrctcProcessor;
 ...
 */
public class RefundDeltaIrctcBatchProcessor extends BatchDeltaIrctcProcessor {

	private static final Logger logger = LoggerFactory.getLogger(RefundDeltaIrctcBatchProcessor.class);
