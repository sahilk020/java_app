...
public class AccountCurrency implements Serializable{
	...
	public String toString() {
		return "AccountCurrency [id=" + id + ", currencyCode=" + currencyCode + ", merchantId=" + merchantId
				+ ", password=" + password + ", txnKey=" + txnKey + ", acqPayId=" + acqPayId + ", directTxn="
				+ directTxn + ", mappedPaymentTypes=" + mappedPaymentTypes + ", currencyName=" + currencyName
				+ ", adf1=" + adf1 + ", adf2=" + adf2 + ", adf3=" + adf3 + ", adf4=" + adf4 + ", adf5=" + adf5
				+ ", adf6=" + adf6 + ", adf7=" + adf7 + ", adf8=" + adf8 + ", adf9=" + adf9 + ", adf10=" + adf10
				+ ", adf11=" + adf11 + "]";
	}
