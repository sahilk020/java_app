...
@Service
public class SettledTransactionDataUpdateService {
	...
	private static Logger logger = LoggerFactory.getLogger(SettledTransactionDataUpdateService.class.getName());
