...
public class CSourceResponseAction extends AbstractSecureAction implements ServletRequestAware {

	private static final long serialVersionUID = -7175329716477436123L;
	...
	private static Logger logger = LoggerFactory.getLogger(CSourceResponseAction.class.getName());

	private Fields responseMap = null;
	private HttpServletRequest httpRequest;
	private String redirectUrl;

	public CSourceResponseAction() {
	}
