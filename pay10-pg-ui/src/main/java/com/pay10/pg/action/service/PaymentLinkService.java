...
public class PaymentLinkService {
	...
	private static Logger logger = LoggerFactory.getLogger(PaymentLinkService.class.getName());
	...
	public String prepareFields(PaymentLink paymentLink) throws SystemException {
		...
		fields.put(FieldType.AMOUNT.getName(),
				Amount.formatAmount(paymentLink.getAmount(), paymentLink.getCurrencyCode()));
	...
	public InvoiceStatus getPaymentLinkPaymentStatus(PaymentLink paymentLink) {
		...
		try {
			...
			BasicDBObject invoiceIdQuery = new BasicDBObject(FieldType.PAYMENT_LINK_ID.getName(), paymentLink.getPaymentLinkId());
