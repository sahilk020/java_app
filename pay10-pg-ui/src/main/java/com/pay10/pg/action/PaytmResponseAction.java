 ...
 *
 */
public class PaytmResponseAction extends AbstractSecureAction implements ServletRequestAware {

	private static Logger logger = LoggerFactory.getLogger(PaytmResponseAction.class.getName());
	...
	public String execute() {
		try {
			...
			fields.put(FieldType.PAYTM_RESPONSE_FIELD.getName(), responseString.toString());
			fields.logAllFields("Paytm Response Recieved :");
			...
			fields.put(FieldType.ACQUIRER_TYPE.getName(), AcquirerType.PAYTM.getCode());
			...
			Map<String, String> response = transactionControllerServiceProvider.transact(fields,
					Constants.TXN_WS_PAYTM_PROCESSOR.getValue());
