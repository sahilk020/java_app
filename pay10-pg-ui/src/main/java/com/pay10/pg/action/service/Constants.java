...
public class Constants {
	...
	public static final String IPAY_SEPARATOR = "|";
	...
	public static final String IPAY_SECURITY_ID = "CRIS";
	...
	public static final String IPAY_RESPONSE_SEPARATOR = "\\|";
	public static final String BANK_TXN_ID = "bankTxnId";
	public static final String STATUS = "status";
	public static final String STATUS_DESC = "statusDesc";
	public static final String SUCCESS = "Success";
	
	public static final String IPAY_RETURN_URL = "IPayIntegrationReturnUrl";
	public static final String IPAY_REQUEST_URL_APPENDER = "_RequestUrl";
	public static final String IPAY_ENQUIRY_URL_APPENDER = "_EnquiryUrl";
	public static final String IPAY_REFUND_URL_APPENDER = "_RefundUrl";
}
