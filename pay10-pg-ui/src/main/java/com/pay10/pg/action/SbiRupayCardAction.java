...
public class SbiRupayCardAction extends AbstractSecureAction implements ServletRequestAware {
    ...
    public String execute() {
        ...
        try {
    		...
    		fields = fieldsDao.getPreviousForPgRefNum(fields.get(FieldType.PG_REF_NUM.getName()));

            User user = userDao.findPayId(fields.get(FieldType.PAY_ID.getName()));
            setConfigurationFromDb(user, fields);
            Map<String, String> response = transactionControllerServiceProvider.transact(fields,
                    Constants.SBI_RUPAY_PA_RQ_FINAL_RESPONSE_HANDLER.getValue());
