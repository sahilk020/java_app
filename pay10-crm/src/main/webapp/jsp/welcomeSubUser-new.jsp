...
<head>
<title>Sub Merchant Dashboard</title>
        ...
        /* var mopdiv ="";
             ...
             for (let key in mopresult) {
              if(count==0){
                ...
                let option = document.createElement("option");
                option.setAttribute('value', data.moplist[key].uiName);
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
  ...
  <s:hidden id="currency" name="currency" value="356" />
  <!--begin::Content-->
                  ...
                  <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                      ...
                      <div class="me-5">
                        ...
                        <!--begin::Desc-->
                        <span
                          class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Farud
                          payments</span>
                        <!--end::Desc-->
                      </div>
                      <!--end::Content-->
