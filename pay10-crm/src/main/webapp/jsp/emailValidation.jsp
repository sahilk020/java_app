					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td align="center"><span
								style="font-size: 34px; font-weight: bold; color: #2b8de9; line-height: 60px;">Congratulations!</span><br /> <span
								style="font-size: 20px; font-weight: bold; color: #333;">Your account has now been activated.<br>Please <s:a action="index" style="color:#496cb6">click here </s:a>
