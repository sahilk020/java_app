      ...
      var mopresult = [];
        ...
        /* var mopdiv ="";
             for(var i = 0; i < mopresult.length; i++){
               ...
               mopdiv=mopdiv+" <option value='"+mopresult[i].code+"'>"+mopresult[i].name+"</option>"
    ...
    <div class="toolbar" id="kt_toolbar">
      ...
      <div id="kt_toolbar_container"
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
          ...
          <!--begin::Title-->
          <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Merchant
            Dashboard</h1>
          <!--end::Title-->
        </div>
                ...
                <div id="wwgrp_currency" class="wwgrp">
                  <div id="wwcntrl_currency" class="wwctrl">
                    <select data-control="select2" class="form-select form-select-solid payment_Methods" style="width: 105% !important"
                      data-hide-search="true" autocomplete="off" name="currency" id="currency" onchange="loadData();">
          ...
          <div class="card-header pt-5 card-toolbar" data-kt-buttons="true">
                  <a
                    class="btn btn-sm  fw-bold btn-active btn-active-primary px-4 me-1"
                    id="buttonYearly">Year</a> <a
                    class="btn btn-sm  fw-bold btn-active btn-active-primary px-4 me-1"
                    id="buttonMonthly">Month</a> <a
                    class="btn btn-sm  fw-bold btn-active btn-active-primary px-4"
                    id="buttonWeekly">Week</a>
                </div>
        <!--end::Page title-->
          ...
          <div class="col-lg-6">
            <div class="card card-flush h-xl-100">
              ...
              <div
                ...
                style="background-image: linear-gradient(339deg, #234B7A
, #234B7A)"
                data-theme="light">
                <!--begin::Title-->
                <h3
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      ...
                      <div
                        ...
                        <div class="m-0">
                          ...
                          <!--end::Number-->
                          <!--begin::Desc-->
                          <span class="text-gray-500 fw-semibold text-center ">Payment Failed by RMS</span>
                          <!--end::Desc-->
                        </div>
                        <!--end::Stats-->
                      </div>
                ...
                <div
                  ...
                  <div class="my-3 col-lg-6 col-md-6 col-sm-12 filter-types">
                    <s:select data-control="select2"
                          ...
                          data-hide-search="true" list="paymentList" listValue="Name" listKey="code"                           name="paymentMethod" id="paymentMethodsFunnel" onchange="getMopType(this.value,'mopTypeFunnel')">
                        </s:select>
                  </div>
                  <div class="my-3 col-lg-6 col-md-6 col-sm-12 filter-types">
                      <select id="mopTypeFunnel" name="mopType" data-control="select2"
                      class="form-select form-select-solid" data-hide-search="true" >
                      <option value="ALL">MOP TYPE</option>
</select>
                  </div>
                  ...
                  <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                      ...
                      <div class="me-5">
                        <!--begin::Title-->
                        <span
                          class="text-gray-800 fw-bold text-hover-primary fs-6">Total Payment Failed by RMS</span>
                        <!--end::Title-->
                        <!--begin::Desc-->
                        <span
                          class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Payment Failed by RMS</span>
                        <!--end::Desc-->
                      </div>
                      <!--end::Content-->
                    </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 filter-dates">
                    ...
                    <div class="row align-items-center my-5"
                      ...
                      <div class="my-md-3 my-lg-0 my-sm-5 my-5 col-lg-6 col-md-6 col-sm-12">
                        <s:select data-control="select2"
                          class="form-select form-select-solid" headerValue="Payment Type" headerKey="ALL"
                          data-hide-search="true" list="paymentList" listValue="Name" listKey="code"                           name="paymentMethod" id="paymentMethods" onchange="getMopType(this.value,'mopType')">
                        </s:select>
                      </div>
                    </div>
                    <div class="row align-items-center my-5"
              ...
              <div class="card-body pt-5">
                ...
                <div class="row my-5">
                  ...
                  <div class="my-3 col-md-12 col-sm-12 filter-types">
                    <s:select data-control="select2"
                          class="form-select form-select-solid" headerValue="Payment Type" headerKey="ALL"
                          data-hide-search="true" list="paymentList" listValue="Name" listKey="code"
              ...
              <div class="card-body ">
                ...
                <div
                  ...
                  <div class="my-3 col-lg-6 col-md-6 col-sm-12 filter-types">
                    <s:select data-control="select2"
                          class="form-select form-select-solid" headerValue="Payment Type" headerKey="ALL"
                          data-hide-search="true" list="paymentList" listValue="Name" listKey="code"                     name="paymentmethod" id="paymentMethodsHourly"  onchange="getMopType(this.value,'mopTypeHourly')">
                  </s:select>
                  </div>
                  <div class="my-3 col-lg-6 col-md-6 col-sm-12 filter-types">
        ...
        <div class="row gx-5 gx-xl-10">
          ...
          <!--end::Col-->
          <!--begin::Col-->
          <div style="display: none;" class="col-lg-6 mb-5 hits-section hourly-trans-section">
