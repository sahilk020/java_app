...
<!-- Added by Akshay -->
<script src="../js/MerchantWallet.js"></script>
			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Merchant Wallet</li>
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item"><span
							class="bullet bg-gray-200 w-5px h-2px"></span></li>
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Merchant Wallet</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
												...
												<div class="col">
													...
													<s:select name="merchant"
														...
														class="form-select form-select-solid" id="merchant" listKey="emailId"
															listValue="businessName" list="merchantList" onchange="loadCurrencies();"/>
												</div>
											</s:if>
											<s:else>
											<div class="col">
												...
												<div  class="col">
													<label class="d-flex align-items-center fs-6 fw-semibold mb-2">Select Currency</label>
													<select data-control="select2" class="form-select form-select-solid payment_Methods" style="width: 105% !important"
													data-hide-search="true" autocomplete="off" name="currency" id="currency">
...
function generateData(d) {
 ...
 return obj2;
	/* if(role=='ADMIN'){
		//table.column(1).header().style.display='none';
		var table = $('#merchantBalance').DataTable();

		var acqFrom = $("#acquirerFrom").val();
		 var obj1 = {
			        acquirerFrom: acqFrom,
			        merchant: merchant,
			        token: token,
			        "struts.token.name": "token",
			    };
