		...
		<head>
			...
			<style type="text/css">
				...
				.nav-pills.nav-pills-rose .nav-item .nav-link.active:hover {
					background: linear-gradient(45deg, #3C4858, #ffffff);
												...
												<div class="tab-pane" id="link111">
													...
													<div class="card-body">
														<table width="100%" class="">
															...
															<tr>
																<th height="25" colspan="4" align="left"
																	valign="middle"><span>Acquirer Response</span>
																</th>
															</tr>
															<tr id="address5">
																<td height="25" colspan="4" align="left"
				...
				<div class="post d-flex flex-column-fluid" id="kt_post">
					...
					<div id="kt_content_container" class="container-xxl">
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
							...
							<!--begin::Title-->
							<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Search Payments</h1>
							<!--end::Title-->
							<!--begin::Separator-->
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-dark">Search Payments</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
											...
											<div class="col-lg-4 col-sm-12 col-md-6">
												<div class="dropdown1">
													...
													<div class="dropdown-content1">
														<a class="" data-column="0">Txn Id</a>
														...
														<a class="toggle-vis" data-column="12">Customer Email</a>
														<a class="toggle-vis" data-column="13">Customer Ph Number</a>
														<a class="toggle-vis" data-column="14">Card Holder Type</a>
														<a class="toggle-vis" data-column="15">PSP Name</a>
														<a class="toggle-vis" data-column="16">Currency</a>
														<a class="toggle-vis" data-column="17">RRN</a>
												...
												<table id="txnResultDataTable"
													...
													<thead>
														<tr class="fw-bold fs-6 text-gray-800">
															...
															<th class="min-w-90px">PSP</th>
															<th class="min-w-90px">Currency</th>
															<th class="min-w-90px">RRN</th>
