				...
				<ul class="nav" id='MenuUl'>
					<div class="accordion" id="accordionExample">
						...
						<li class="nav-item " id='transactionSearch'><s:a
								action='transactionSearch' class="nav-link">
							...
							<li class="nav-item " id="headingOne"><a class="nav-link"
								...
								<div class="collapse" id="transReports"
									...
									<ul class="nav">
										...
										<li class="nav-item " id="summaryReports"><s:a
												action='summaryReports' class="nav-link">
						...
						<div class="card_sidebar">
							<li class="nav-item " id="headingOne"><a class="nav-link"
								data-toggle="collapse" data-target="#chargeback"
								href="#chargeback" id='a-chargeback'> <i
						...
						<div class="card_sidebar">
							<li class="nav-item " id="headingSeven">
								...
								<div class="collapse" id="fraudPrevention" aria-labelledby="headingSeven"
									...
									<ul class="nav">
										<li class="nav-item " id="merchantRestrictionAction">
											<s:a action="merchantRestrictionAction" class="nav-link">
					...
					<li class="nav-item " id="headingEleven">
						<a class="nav-link" data-toggle="collapse" data-target="#accountsFinance" href="#accountsFinance" id="a-accountsFinance">
							<i class="material-icons">monetization_on</i>
							<p> Accounts & Finance
								<b class="caret"></b>
							</p>
						</a>
						<div class="collapse" id="accountsFinance"  aria-labelledby="headingEleven"
						data-parent="#accordionExample">
							<ul class="nav">
