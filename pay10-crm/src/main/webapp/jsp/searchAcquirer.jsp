						...
						.DataTable(
							{
								...
								"aoColumns": [
...

									{
										...
										"bSortable": false,
										"mRender": function () {
											return '<button class="btn btn-primary btn-xs" disabled="disabled" name="acqirerEdit" id="acqirerEdit">Edit</button>';
										}
									},
									{
										"mData": "payId",
							...
							.on(
								...
								function () {
									...
									if (columnVisible == 4) {
										...
										if ($("#acqirerEdit").attr("disabled") == undefined) {
				...
				<div class="toolbar" id="kt_toolbar">
					...
					<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
						...
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
							...
							<!--begin::Title-->
							<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Acquirer List</h1>
							<!--end::Title-->
							<!--begin::Separator-->
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-dark">Acquirer List</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
													...
													<div class="col-lg-4 col-sm-12 col-md-6">
														<div class="dropdown1">
															...
															<div class="dropdown-content1">
																...
																<a class="toggle-vis" data-column="3">Business Name</a>
