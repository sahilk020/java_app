    ...
    <div class="toolbar" id="kt_toolbar">
      ...
      <div id="kt_toolbar_container"
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
          ...
          <!--begin::Title-->
          <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Admin
            Dashboard</h1>
          <!--end::Title-->
        </div>
        ...
        <div class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1" style="margin-left: auto;">
                    <s:select headerKey="ALL MERCHANTS" headerValue="ALL MERCHANTS" data-control="select2"
                          ...
                          name="merchant" id="merchant" onchange="loadCurrencies();">
                    </s:select>
                ...
                <div
                  ...
                  <div class="my-3 col-lg-6 col-md-6 col-sm-12 filter-types">
                    <s:select data-control="select2"
                          ...
                          data-hide-search="true" list="@com.pay10.commons.util.PaymentTypeUI@values()" listValue="name" listKey="code"
            ...
            <div class="card card-flush h-md-100">
              ...
              <div class="card-body pt-5">
                ...
                <div class="row my-5">
                  ...
                  <div class="my-3 col-md-12 col-sm-12 filter-types" style="display:none">
                    <s:select data-control="select2"
                          class="form-select form-select-solid" headerValue="Payment Type" headerKey="ALL"
                          data-hide-search="true" list="@com.pay10.commons.util.PaymentTypeUI@values()" listValue="name" listKey="code"
                ...
                <div class="row my-5">
                  <div class="my-3 col-md-6 col-sm-12 filter-types" style="display:none">
