<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	...
	<%@ taglib uri="/struts-tags" prefix="s" %>
		...
		<head>
			<title>Old Bhartipay report</title>
					...
					<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
						<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
							...
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
								...
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-muted">Search Payment</li>
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item"><span class="bullet bg-gray-200 w-5px h-2px"></span></li>
								<!--end::Item-->
								<!--begin::Item-->
								<li class="breadcrumb-item text-dark">Old Bhartipay Report</li>
								<!--end::Item-->
							</ul>
							<!--end::Breadcrumb-->
						</div>
										...
										<div class="row g-9 mb-8 justify-content-end">
											<div class="col-lg-4 my-2">
												...
												<s:select name="status"
													class="form-select form-select-solid adminMerchants" id="status"
													 list="status" listKey="status"
													listValue="status" autocomplete="off" />
											</div>
...
<%-- 													<span class=""></span> --%>
<!-- 												</label> <input type="button" id="fetchTransaction" value="Fetch" -->
...
<!-- 											</div> -->
											...
											<div class="col-lg-2 my-2">
												<label class="d-flex align-items-center fs-6 fw-bold mb-2 mt-2">
													<span class=""></span>
												</label> <input type="button" id="DownloadTransaction" value="Download"
													class="btn btn-primary  mt-4 submit_btn">
											</div>
...
// 					$("#fetchTransaction").click(function () {
...
// 					}
					...
					$("#DownloadTransaction").click(function () {
						...
						if (dateFrom == null || dateTo == null) {
							...
							alert('From date must be before the to date');
							return false;
						} else if (dateTo - dateFrom > 1 * 86400000) {
							alert('No. of days can not be more than 2');
							return false;
						} else {
							$("#statuss").val($("#status").val());
							$("#dateFromm").val($("#dateFrom").val());
							$("#dateToo").val($("#dateTo").val());
							
							$("#OldBhartipayReportList").submit()
						}
					});
				</script>
				<form action="OldBhartipayReportListDownload" id="OldBhartipayReportList">
					<input type="hidden" name="status" id="statuss">
					<input type="hidden" name="dateFrom" id="dateFromm">
					<input type="hidden" name="dateTo" id="dateToo">
				</form>
		</body>
