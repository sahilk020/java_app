	...
	function getListpayment(){
		...
		if(acquirer==""){}else{			var urls = new URL(window.location.href);
		    ...
		    debugger
			 $.ajax({
					type : "POST",
					url : domain+"/crmws/AcquirerSwitch/getPaymentType",
					timeout : 0,
					data : {
			...
			.DataTable(
					{
						...
						"ajax" : {
							"url" : domain+"/crmws/AcquirerSwitch/getMappedAcquirer?acquirerType="+acquirer+"&PaymentType="+payment,
							"type" : "POST",
							"data" : {
...
<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Acquirer Master Switch</h1>
									<!--end::Title-->
									<!--begin::Separator-->
...
">				
							<div class="col-md-6 fv-row">
								<label	class="d-flex align-items-center fs-6 fw-bold mb-2">
									<span class="">Acquirer :</span>
											...
											id="acquirer3" autocomplete="off" value="" onchange="getListpayment()" />
							...
							<div class="col-md-8 fv-row" style="padding-left: 70px;">
								...
								<label class="switch"> <input
																						onchange="hideAndShowForAuto(this)"				type="checkbox" id="autoRefund"
																										> <span
...
function hideAndShowForAuto(event){
	document.getElementById("loading").style.display = "none";
	  ...
	  if(! autoRefund){
		    ...
		    $.ajax({
				type : "POST",
				url : domain+"/crmws/AcquirerSwitch/changeStatusAcquirerMaster",
				timeout : 0,
				data : {
					"acquirer":acquirer,
					"paymentType":payment,
		  ...
		  debugger
		    ...
		    $.ajax({
				type : "POST",
				url : domain+"/crmws/AcquirerSwitch/changeStatusActive",
				timeout : 0,
				data : {
					"acquirer":acquirer,
					"paymentType":payment,
