				...
				<ul class="nav" id='MenuUl'>
					...
					<!-- <li class="nav-item "  id='home'>
					   ...
					   <div class="card_sidebar">
						<s:if
							test="%{#session['USER_PERMISSION'].contains('View Search Payment')}">
						...
						<li class="nav-item " id="headingOne">
							...
							data-parent="#accordionExample">
                                <ul class="nav">
									<s:if
						test="%{#session['USER_PERMISSION'].contains('Create Admin')}">
									...
									<s:if
						test="%{#session['USER_PERMISSION'].contains('View Admin List')}">
						...
						<div class="card_sidebar">
							<s:if
							test="%{#session['USER_PERMISSION'].contains('View Tenant List')}">
...
<script>
	...
	if(currentUrl.includes("transactionSearchSuperAdmin")) {
	...
	}else if(currentUrl.includes("adminSignup") || currentUrl.includes("viewAdmin")) {
		...
		if (currentUrl.includes("adminSignup")) {
			...
			$('#a-createTenant').attr('aria-expanded', true);
			 if (currentUrl.includes("tenantListPage")) {
				$('#tenantListPage').addClass('active');
			} 
		}else if (currentUrl.includes("superAdminProfile") || currentUrl.includes("loginHistoryRedirectSuperAdmin") || currentUrl.includes("passwordChange")) {
