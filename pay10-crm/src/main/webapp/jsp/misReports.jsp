...
<script type="text/javascript" src="../js/MisReports.js"></script>
...
<body id="mainBody" class="content flex-column">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" align="center">Confirm Refund
					Instruction</div>
				<div class="modal-body">Please Verify the details before
					submission.</div>
	...
	<div class="post d-flex flex-column-fluid" id="kt_post">
		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<!--begin::Title-->
					<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">MIS
						Report</h1>
					<!--end::Title-->
					<!--begin::Separator-->
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">MIS Report</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
		...
		<div id="kt_content_container" class="container-xxl">
			<form id="misReportQuery" name="misReportQuery" class="form mb-15"
				action="misReportQuery">
							...
							<div class="card-body">
								...
								<div class="row g-9 mb-8">
									<div class="col-md-4 fv-row">
										...
										<s:if
											...
											<s:select name="merchant"
												...
												id="merchant_selector" headerKey="ALL" headerValue="ALL"
												list="merchantList" listKey="payId" listValue="businessName"
												autocomplete="off" onchange="loadAcquirer();" />

										</s:if>
										<s:else>
											<s:select name="merchant" class="input-control"
												id="merchant_selector" list="merchantList" listKey="emailId"
												listValue="businessName" autocomplete="off"
												onchange="loadAcquirer();" />
										</s:else>
									...
									<div class="col-md-4 fv-row">
										...
										<!--end::Label-->
										<select name="currency" id="currency" data-control="select2" data-placeholder="Currency" class="form-select form-select-solid" data-hide-search="true">

										</select>
										<%-- <s:select headerKey="ALL" headerValue="ALL"
											data-control="select2" data-placeholder="Currency"
											class="form-select form-select-solid" data-hide-search="true"
											list="currencyMap" name="currency" id="currency"
  ...
  $('#downloadReport').click(function() {
    var dateFromValue = document.getElementById('kt_datepicker_1').value;
    var dateToValue = document.getElementById('kt_datepicker_2').value;

    if (!dateFromValue || !dateToValue) {Swal.fire({
		title: "Error!",
		text: "Enter date value!",
		icon: "error",
    ...
    var dateFromParts = dateFromValue.split("-");
    var dateToParts = dateToValue.split("-");

    var newdate = new Date(dateFromParts[1] + '/' + dateFromParts[0] + '/' + dateFromParts[2]);
    var newdate2 = new Date(dateToParts[1] + '/' + dateToParts[0] + '/' + dateToParts[2]);
    ...
    var differenceInDays = (newdate2 - newdate) / (1000 * 3600 * 24);
    if (differenceInDays > 7) {
		Swal.fire({
		title: "Error!",
		text: "No. of days can not be more than 7!",
		icon: "error",
		allowOutsideClick:false
		});
		return false;
	...
	const checkboxes = document.querySelectorAll('.myCheckBox');
            ...
            if (!anyChecked) {
				Swal.fire({
				title: "Error!",
				text: "Acquirer must be selected!",
				icon: "error",
				allowOutsideClick:false
				});
				return false;
	}
    var form = $('#misReportQuery');
	...
	<script>
		...
		function showCheckboxes(e) {
			...
			// Close the dropdown if the event target is not within the selectBox
		...
		document.addEventListener("DOMContentLoaded", function() {
			var form = document.getElementById("misReportQuery");
