		...
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img
					src="../image/irctcipay.png" style="width:120px; margin-left:20px; margin-top:-2px;"></a>
			</div>
			...
			<div id="main">
				<div class="sidebar-collapse">
					<ul id="navigation" class="nav side-menu">
						...
						<li><s:a action='searchTransactionAgent' class="head1">
							<i class="fa fa-search"></i>Search Transaction </s:a>
						</li>
						
						<li><a style="cursor: pointer" class="head"><i
									class="fa fa-file"></i> Agent Access <span
									class="fa fa-chevron-down" style="margin-left:30%;" id="arrow"></span></a>
							<ul>
									
								<li><s:a action='agentSearch'>Agent Search</s:a></li>
							</ul>
						</li>
						...
						<li><a style="cursor: pointer" class="head"><i
								...
								class="fa fa-chevron-down" style="margin-left:35%;" id="arrow"></span></a>
							<ul>
							
								<li><s:a action="agentProfile" >My Profile </s:a></li>
