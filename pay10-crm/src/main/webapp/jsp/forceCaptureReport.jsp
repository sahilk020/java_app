...
<title>Force Captured Summary Report</title>
<link
											...
											function downloadData(){
												...
												debugger
													...
													if (flag == true) {
														...
														var transTo1 = new Date(Date.parse(document
															.getElementById("dateTo").value)); */
														if (document.getElementById("dateFrom").value == null || document.getElementById("dateTo").value == null) {
															alert('Enter date value');
														...
														if (new Date(Date.parse(document.getElementById("dateTo").value)) - new Date(Date.parse(document.getElementById("dateFrom").value)) > 31 * 86400000) {
											  ...
											  function downloadData1() {
												...
												$("#acquirer1").val(document.getElementById("acquirer").value);
												$("#dateFrom1").val(document.getElementById("dateFrom").value);
												$("#dateTo1").val(document.getElementById("dateTo").value);
												// $("#settlementDateFrom1").val(document.getElementById("settlementDateFrom").value)
												// $("#settlementDateTo1").val(document.getElementById("settlementDateTo").value)
												//$("#status1").val(document.getElementById("status").value);
												$("#status1").val("Force Captured");
												var token = document.getElementsByName("token")[0].value;


												$("#downloadForceCaptured").submit();
...
<body>
	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container"
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
				...
				<!--begin::Title-->
				<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Force
					Captured Summary Report</h1>
				<!--end::Title-->
				<!--begin::Separator-->
				...
				<ul
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-dark">Force Captured Summary Report</li>
					<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
		...
		<div id="kt_content_container" class="container-xxl">
			<div class="row my-5">
				<div class="col">
					...
					<div class="card-text">
						<h4 class="card-title">Force Captured Report</h4>
					</div>
				</div> -->
								...
								<div class="card-body ">
									...
									<form id="IDTDRBifurcationReport">
										...
										<div class="row my-3 align-items-center">
											...
											<div class="col-lg-3 my-2">
												<label class="d-flex align-items-center fs-6 fw-bold mb-2">
													<span class="required">Force Captured Date From</span>
												</label>
												<!--begin::Icon-->
											...
											<div class="col-lg-3 my-2">
												<label class="d-flex align-items-center fs-6 fw-bold mb-2">
													<span class="required">Force Captured Date To</span>
												</label>
												<!--begin::Icon-->
												<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
												<span class="svg-icon svg-icon-2 position-absolute mx-4">
								...
								<div class="col-lg-4 col-sm-12 col-md-6">
									<div class="dropdown1">
										...
										<div class="dropdown-content1">
											<a class="toggle-vis" data-column="1">Txn Id</a> <a
												class="toggle-vis" data-column="2">Pg Ref Num</a> <a
												class="toggle-vis" data-column="3">Merchant</a> <a
												class="toggle-vis" data-column="4">Date</a> <a
												class="toggle-vis" data-column="5">Order Id</a> <a
												class="toggle-vis" data-column="6">Refund Order Id</a> <a
												class="toggle-vis" data-column="7">Mop Type</a> <a
												class="toggle-vis" data-column="8">Payment Method</a> <a
												class="toggle-vis" data-column="9">Txn Type</a> <a
												class="toggle-vis" data-column="10">Status</a> <a
												class="toggle-vis" data-column="11">Base Amount</a> <a
												class="toggle-vis" data-column="12">Total Amount</a> <a
												class="toggle-vis" data-column="12">Pay ID</a> <a
												class="toggle-vis" data-column="14">Customer Email</a> <a
												class="toggle-vis" data-column="15">Customer Ph Number</a> <a
												class="toggle-vis" data-column="16">UDF4</a> <a
												class="toggle-vis" data-column="17">UDF5</a> <a
												class="toggle-vis" data-column="18">UDF6</a>
										</div>
									</div>
								</div>
							</div>
								...
								<table id="txnResultDataTable"
									...
									<thead>
										<tr class="boxheadingsmall">
											...
											<th style='text-align: center'>UDF4</th>
											<th style='text-align: center'>UDF5</th>
											<th style='text-align: center'>UDF6</th>
											<th></th>
											<th></th>
											<th></th>
											<th></th>
	...
	<form action="DownloadForceCapturedReport" id="downloadForceCaptured"
		method="post">
	<input id="merchant1" name="merchant" type="hidden">

	<input id="acquirer1" name="acquirer" type="hidden">
	<input id="dateFrom1" name="dateFrom" type="hidden">
	<input id="dateTo1" name="dateTo" type="hidden">
	<!-- <input
				id="settlementDateFrom1" name="settlementDateFrom" type="hidden"> -->
	<!-- <input id="settlementDateTo1" name="settlementDateTo" type="hidden">-->
	<input id="status1" name="status" value="Force Captured" type="hidden">
