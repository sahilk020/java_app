...
<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Admin Profile</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Admin Profile</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
...
<div class="error-text"><s:actionmessage/></div>
	...
	<div class="tab-pane active"  id="MyPersonalDetails" >
						...
						<div>
							...
							<s:elseif test="%{#session.USER.UserType.name()=='ADMIN' || #session.USER_TYPE.name()=='SUBADMIN'}">
								<tr>
									<td height="30" align="left" valign="middle" class="greytdbg" width="20%"><strong>Email
											ID:</strong></td>
									<td align="left" class="greytdbg" width="20%"><s:property
