...
$(document).ready(function(){
  ...
  $('.form-select').select2();
  var modalSelects = $(".modal .form-select");
  for(var i=0;i<modalSelects.length;i++){
      var modal = $(modalSelects[i]).closest(".modal");
      console.log(modalSelects[i]);
      console.log(modal);
      $(modalSelects[i]).select2({
...
$(document).click(function (e) {
    ...
    if ($(e.target).is('#myModal20')) {

    $('#tagvpaAddress').tagsinput('removeAll');
    $('#tagvpaAddress .tag.label.label-info').remove();
    if($('#alwaysOnFlag20').prop('checked')){
      $('#alwaysOnFlag20').trigger( "click" );
      var dvTimebased20 = document.getElementById("dvTimebased20");
      dvTimebased20.style.display =  "block";
...
function tagsAddRule(geoLocationType, elementName, elementId, elementValue, countryNameForState, selectedState){
  ...
  //Added By Sweety
   $("#tagvpaAddress").css("display","block");
  $("#tagtagvpaAddressAddress").remove();
...
//Added By Sweety
function ShowHideDiv20(alwaysOnFlag20) {
        var dvTimebased20 = document.getElementById("dvTimebased20");
        dvTimebased20.style.display = alwaysOnFlag20.checked ? "none" : "block";
        $('#alwaysOnFlag2020').text($('#alwaysOnFlag20').val());
    $("#alwaysOnFlag20").on('change', function() {
      if ($(this).is(':checked')) {
       $(this).attr('value', 'true');
     } else {
      $(this).attr('value', 'false');
                              ...
                              <div class="col-sm-6 col-lg-6 ">
                                ...
                                <div class="txtnew">
                                  <s:select name="payId" headerKey="ALL" headerValue="ALL" class="form-select form-select-solid" id="payId" list="merchantList"
                                    listKey="payId" listValue="businessName" autocomplete="off" onchange="getCurrencyByPayID(this);" />
                                </div>
                              </div>
                              <div class="col-sm-6 col-lg-6">
                                 <label class="d-flex align-items-center fs-6 fw-semibold mb-2"> Select Currency</label><br>
                                 <div class="txtnew">
                                   <select name="currencyId" headerKey="ALL"   class="form-select form-select-solid" id="currencyId"
                                     listKey="currencyId"   autocomplete="off"  multiple="true" onchange="displaySwitch(this);" >
                                     </select>
                                 </div>
                            </div>
                          </div>
            ...
            <div id="1" class="modal-body">
              ...
              <table class="detailbox table98" cellpadding="20" id="dvTimebased1"  >
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  ...
                  <td width="30%">
                    <div class="t-ip date">
                    <input type="text" class="form-control form-control-solid wid startTime" id="startTime" name="startTime" placeholder="HH:MM:SS" autocomplete="off" />
                ...
                <tr class="fw-bold fs-6 text-gray-800" id="ipTrTable">
                  <td width="8.6%">
                    ...
                    <tr class="fw-bold fs-6 text-gray-800">
                      <td colspan="2" >
                        ...
                        <button type="submit" value="Block" id="blockIp"
                          ...
                          <button type="button" class="btn btn-danger btn-sm btn-block" style="width:21%;height:100%;margin-top:1%;" data-dismiss="modal">Close</button>
                        </div></td>
                    </tr>
                    <tr class="fw-bold fs-6 text-gray-800">
                      ...
                      <td><p>Note: MAXIMUM 150 Entries are allowed to upload</p></td>
                    </tr>
              </table>
            </div>
          </div>
          ...
          <div class="modal-body" style="overflow:auto;max-height:520px;">
            <ul id="issuerCountry" class="checklist" data-name="country">
                ...
                <div class="modal-footer" style="display: flex;">
                  ...
                  <button type="button" class="btn btn-danger btn-sm " style="margin-left: 5px;" data-dismiss="modal">Close</button>
                </div>
              </div>
        </div>
      </div>
            ...
            <div id="6" class="modal-body">
              <table class="detailbox table98" cellpadding="20">
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  ...
                  flex-flow: nowrap;">
                      <input id="cardIntialDigits" placeholder="Initial 6-digits of card" type="text" maxlength="6"
                        minlength="6" class="form-control form-control-solid sample_cn mb-4"
                        onkeypress="return isNumberKey(event)" onblur="makeCardMaskini()" />
                      <span class="" id="validate_crdIn" style="font-size: 10px;  margin-top:35px;"></span>
                    ...
                    <input id="cardLastDigits" placeholder="Last 4-digits of card" type="text" maxlength="4" minlength="4" name="negativeCard" class="form-control form-control-solid mb-4" style="width:50%!important; position:relative; left:10px;" onkeypress="return isNumberKey(event)" onblur="makeCardMasklst()" />
                       <span class="" id="validate_crdL" style="font-size: 10px;  margin-bottom:20px; margin-top:35px;"></span>
              ...
              <table class="detailbox table98" cellpadding="20">
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  ...
                  width: 93% !important;">
                    ...
                    onblur="iniCardMask()"/>
					<span class="" id="validate_crdInpre" style="font-size: 10px; position:fixed; margin-top:40px;" ></span>
                      ...
                      <input id="precardLastDigits" name="precardLastDigits" placeholder="Last 4-digits of card" type="text" maxlength="4" name="prenegativeCard" class="form-control form-control-solid mb-4" style="width:50%!important; position:relative; left:10px;" onkeypress="return isNumberKey(event)" onblur="lastCardMask()" />
					   			<span class="" id="validate_crdLpre" style="font-size: 10px; margin-top:35px;"></span>
          ...
          <div id="7" class="modal-body">
            ...
            <tr class="fw-bold fs-6 text-gray-800">
              ...
              <tr class="fw-bold fs-6 text-gray-800">
                ...
                <button type="button" class="btn btn-danger btn-sm" style="margin-top:1%;" data-dismiss="modal">Close</button>
              </div>
            </td>
              </tr>
            </table>
        ...
        <div class="modal-content">
          ...
          <div id="7" class="modal-body" style="padding-top: 0px;">
            ...
            <tr class="fw-bold fs-6 text-gray-800">
             ...
             <!-- <tr class="fw-bold fs-6 text-gray-800">
                <td width="7%"><label for="">Currency *</label></td>
                                        <td width="30%"><s:select name="currency" class="form-select form-select-solid actions" id="currencymop" list="currencyMap"/></td>
              </tr>-->
              <tr class="fw-bold fs-6 text-gray-800">
                <td width="7%"><label for="">Email Address To Notify *</label></td>
                <td width="30%">
...
<div id="myModal20" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none !important">
        <div class="modal-dialog" style="width: 600px;">

          <!-- Modal content-->
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Block Customer VPA Address</h5>
              <button type="button" class="close" id="fraudRuleModalClose" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true"><i class="fa fa-remove"></i></span>
              </button>
              </div>
            <div id="20" class="modal-body">
              <table class="detailbox table98" cellpadding="20">
                    <tr class="fw-bold fs-6 text-gray-800">
                      <td colspan="2" height="30" align="left">
                        <p>
                          Enter the VPA address you wish to block.<br>
                          <br> e.g. abc123@ybl<br>
                          <br> Once added, all transactions from the VPA address will be blocked.
                        </p>
                      </td>
                    </tr>
                    <tr class="fw-bold fs-6 text-gray-800">
                      <td width="7%">
                        <label for="alwaysOnFlag1">
                          <input type="checkbox" name="alwaysOnFlag20" id="alwaysOnFlag20" value="false" onclick="ShowHideDiv20(this)" />
                          <input type="hidden" name="alwaysOnFlag2020" id="alwaysOnFlag2020" />
                        </label>
                      </td>
                    ...
                    <tr class="fw-bold fs-6 text-gray-800">
                      <td width="8%"><label for="">VPA Address *</label></td>
                      <td width="31.8%"><span class="" id="validate_err" ></span>
                        <input id="vpaAddress" type="text" placeholder="abc@ybl"
                        name="vpaAddress" value=""  class="form-control form-control-solid vpaAddress mb-4" data-role="tagsinput" />
                      </td>
                    </tr>
                                <!-- New Html Code Time Based Fraud Rule-->

              <table class="detailbox table98" cellpadding="20" id="dvTimebased20"  >
                <tr class="fw-bold fs-6 text-gray-800">
                  <td width="8.6%">
                    <label for="VPAdateFrom">Start Date *</label>
                  </td>
                  <td width="30%">
                    <div class="startdatepicker date t-ip">
                    <input class="form-control form-control-solid flatpickr-input From" type="text" id="dateActiveFromVpa" name="dateActiveFrom" placeholder="DD/MM/YYYY" autocomplete="off" readonly="readonly" />
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                    </div>
                  </td>
                </tr>
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  <td width="8.6%">
                    <label for="VPAdateTo">End Date *</label>
                  </td>
                  <td width="30%">
                    <div class="expiredatepicker date t-ip">
                    <input class="form-control form-control-solid flatpickr-input To" type="text" id="dateActiveToVpa" name="dateActiveTo" placeholder="DD/MM/YYYY" autocomplete="off" readonly="readonly"/>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                    </div>
                  </td>
                </tr>
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  ...
                  <td width="30%">
                    <div class="t-ip date">
                    <input type="text" class="form-control form-control-solid wid startTime" id="startTimeVpa" name="startTime" placeholder="HH:MM:SS" autocomplete="off" />
                    <span class="input-group-addon" style="padding: 5px 12px;">
                    <span class="glyphicon glyphicon-time"></span>
                    </span>
                    </div>
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  ...
                  <td width="30%">
                    <div class="t-ip date">
                    <input type="text" class="form-control form-control-solid wid endTime" id="endTimeVpa" name ="endTime" placeholder="HH:MM:SS" autocomplete="off"    />
                    <span class="input-group-addon" style="padding: 5px 12px;">
                    <span class="glyphicon glyphicon-time"></span>
                    </span>
                    </div>
                ...
                <tr class="fw-bold fs-6 text-gray-800">
                  ...
                  <td width="30%">
                    <ul id="repeatDays" class="checklist-week" data-name="repeatDays">
                      <li>
                        <label>
                          <input type="checkbox" name="repeatDays" id="repeatDays77"  value="SUN" class="ip4ClassWeeks">
                          <span>SUN</span>
                        </label>
                      </li>
                      <li>
                        <label>
                          <input type="checkbox" name="repeatDays" id="repeatDays78" value="MON" class="ip4ClassWeeks">
                          <span>MON</span>
                        </label>
                      </li>
                      <li>
                        <label>
                          <input type="checkbox" name="repeatDays" id="repeatDays79" value="TUE" class="ip4ClassWeeks">
                          <span>TUE</span>
                        </label>
                      </li>
                      <li>
                        <label>
                          <input type="checkbox" name="repeatDays" id="repeatDays80" value="WED" class="ip4ClassWeeks">
                          <span>WED</span>
                        </label>
                      </li>
                      <li>
                        <label>
                          <input type="checkbox"  name="repeatDays" id="repeatDays81" value="THU" class="ip4ClassWeeks">
                          <span>THU</span>
                        </label>
                      </li>
                      <li>
                        <label>
                          <input type="checkbox" name="repeatDays" id="repeatDays82" value="FRI" class="ip4ClassWeeks">
                          <span>FRI</span>
                        </label>
                      </li>
                      <li>
                        <label>
                          <input type="checkbox" name="repeatDays" id="repeatDays83" value="SAT" class="ip4ClassWeeks">
                          <span>SAT</span>
                        </label>
                      </li>
                    </ul>
                    ...
                    <tr class="fw-bold fs-6 text-gray-800">
                      <td colspan="2" >
                        <div style="display: flex;">
                        <button type="submit" value="Block" id="blockVpa"
                          onclick="ajaxFraudRequest(vpaAddressS)" class="btn btn-primary btn-sm btn-block" style="margin-left: 10%;width:21%;height:100%;margin: 1%;">Block</button>
                          <button type="button" class="btn btn-danger btn-sm btn-block" style="width:21%;height:100%;margin-top:1%;" data-dismiss="modal">Close</button>
                        </div></td>
                    </tr>
                    <tr class="fw-bold fs-6 text-gray-800">
          ...
          <div class="col-md-12" style="align-items: flex-end;">
            <div class="bkn">
              ...
              <div class="adduT row">
                ...
                <div class="col-md-2">
                  <input class='btn btn-info btn-md' id="searchResult"   type='submit' value='Search' onclick="searchData('ipAddListBody','BLOCK_IP_ADDRESS')">

                </div>
                <div class="col-md-2">
                  <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule('ipAddListBody','BLOCK_IP_ADDRESS')">
                </div>
            ...
            <div class="adduT row">
               <table>
                ...
                <td style="width:6%">
                  ...
                  <div class="col-md-3">
                  <input class='btn btn-info' id="searchResult2"   type='submit' value='Search' onclick="searchData('issuerCountryListBody','BLOCK_CARD_ISSUER_COUNTRY')">

                </div>
                <div class="col-md-3">
                  <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule()">
                </div>
            ...
            <div class="adduT row">
               <table>
                ...
                <td style="width:6%">
                  ...
                  <div class="col-md-2">
                  <input class='btn btn-info btn-md' id="searchResult7"   type='submit' value='Search' onclick="searchData('userCountryListBody','BLOCK_USER_COUNTRY')">

                </div>
                <div class="col-md-2">
                  <input class='btn btn-danger btn-md bulkDeleteBtn disabled' name="deleteRules" type='submit' value='Bulk Delete' onclick="bulkDeleteFraudRule()">
                </div>
            ...
            <div class="bkn">
              ...
              <div class="adduT row">
                  ...
                  data-toggle="modal" data-target="#myModal5"/>
                    ...
                    <div class="col-md-2">
                    <input class='btn btn-info btn-md' id="searchResult3"   type='submit' value='Search' onclick="searchData('emailListBody','BLOCK_EMAIL_ID')">
                    </div>
                    <div class="col-md-2">
                      <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule()">
                    </div>
                ...
                <div class="adduT row">
                  ...
                  <td style="width:6%">
                    ...
                    data-toggle="modal" data-target="#myModal3"/>
                      ...
                      <div class="col-md-2">
                      <input class='btn btn-info btn-md' id="searchResult4"   type='submit' value='Search' onclick="searchData('cardBinListBody','BLOCK_CARD_BIN')">
                      </div>
                      <div class="col-md-2">
                        <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule()">
                      </div>
          ...
          <div class="col-md-12" style="align-items: flex-end;">
            <div class="bkn">
              ...
              <div class="adduT row">
                  ...
                  <div class="col-md-2">
                  <input class='btn btn-info btn-md' id="searchResult6"   type='submit' value='Search' onclick="searchData('cardNoListBody','BLOCK_CARD_NO')">
                  </div>
                  <div class="col-md-2">
                    <input class='btn btn-danger btn-md bulkDeleteBtn disabled'type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule()">
                  </div>
        ...
        <div class="bkn">
          ...
          <div class="adduT row">
              ...
              data-toggle="modal" data-target="#myModal12"/>
                ...
                <div class="col-md-2">
                <input class='btn btn-info btn-md' id="searchResult5"   type='submit' value='Search' onclick="searchData('phoneListBody','BLOCK_PHONE_NUMBER')">
                </div>
                <div class="col-md-2">
                  <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule()">
                </div>
              ...
              <div class="col-md-2">
                <input class='btn btn-danger btn-md bulkDeleteBtn'  type='submit' value='Bulk Delete' onclick="bulkDeleteFraudRule('phoneListBody','BLOCK_PHONE_NUMBER')">
              </div> -->
            </div></td>
              </tr>
            </table>
                ...
                <div class="bkn">
                  <div class="adduT row">
                    <table>
                      ...
                      <div class="col-md-2">
                        <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule('mackAddListBody','BLOCK_MACK_ADDRESS')">
                      </div>
                      </tr>
                    </table>
                  </div>
                ...
                <div class="bkn">
                  <div class="adduT row">
                    <table>
                      ...
                      <div class="col-md-2">
                        <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule('repeatedMopTypeListBody','REPEATED_MOP_TYPES')">
                      </div>
                      </tr>
                    </table>
                  </div>
                  ...
                  <thead>
                   ...
                   <!--   <td>Currency</td>-->
                    ...
                    <tr class="boxheadingsmall" style="font-size: 11px;">
                      ...
                      <td width="20%">
                      <input type="number" id="transactionAmountFTxn" placeholder="10" onpaste="return false" name="transactionAmount" min="" max="9999999999.99" step="0.01" onkeypress="return isNumberKeyAmount(event)" class="form-control form-control-solid"/></td>
...
-->
  ...
  <div>
    ...
    <div>
           <div class="row my-5">
            <div class="col">
      <div class="card card_graph"   id="cardcb30" ><!--onclick="monthlycardupdateTabState(this)"-->
        <div class="card-header " role="tab" id="headingTwo30">
          <a class="collapsed" >
            ...
            <div class="card-icon" id="cardIcon">
             ...
             <h4 class="card-title">Block VPA Addresses
             <i data-toggle="collapse" data-parent="#accordionEx1" href="#collapse30"
              aria-expanded="false" aria-controls="#collapse30" class="fa fa-angle-down rotate-icon"></i>
              <label class="switch" style="float: right; display: none">
                <input type="checkbox" id="onVpaAddressBlocking" name="onVpaAddressBlocking" onclick="updateConfig(this);">
                <span class="slider round"></span>
              </label>
              </h4>
              </div>
 ...
 <div id="collapse30" class="collapse active " role="tabpanel" >
<div class="card-body">
    <div class="row">
    <div class="col-md-12 col-xs-12">
          ...
          <div class="col-md-12" style="align-items: flex-end;">
            <div class="bkn">
              ...
              <div class="adduT row">
                ...
                <div class="col-md-3">
                  <input   type='search' class="form-control form-control-solid form-control form-control-solid-solid " id="search_vpaAddListBody"  placeholder="Search VPA Address">
                </div>
                <div class="col-md-2">
                  <input class='btn btn-info btn-md' id="searchResult"   type='submit' value='Search' onclick="searchData('vpaAddListBody','BLOCK_VPA_ADDRESS')">

                </div>
                <div class="col-md-2">
                  <input class='btn btn-danger btn-md bulkDeleteBtn disabled' type='submit' name="deleteRules" value='Bulk Delete' onclick="bulkDeleteFraudRule('vpaAddListBody','BLOCK_VPA_ADDRESS')">
                </div>

                  <div class="col-md-2">
                  <input class='btn btn-info btn-md' id="downLoadResult"   type='submit' value='Download' onclick="downloadData()">
              ...
              <div>
                ...
                <div class="table-responsive" >
                  ...
                  <table id="vpaAddListBody" class="table table-striped table-row-bordered gy-5 gs-7">
                    <thead>
                      <tr class="fw-bold fs-6 text-gray-800">
                        <th>Merchant</th>
						<th>Currency</th>
                       ...
                       <!--  <th>Start Date</th>
                        ...
                        <th>Edit</th>
                        <th>Delete</th>
                        <th> <input class="form-check-input" type="checkbox" id="select_all20" style="margin-right:10px;" value="" onclick="selectall()">
                          <span class="form-check-sign">
                            <span class="check"></span>Action/Select All
            ...
            <div class="card-header card-header-rose card-header-text">
              <div class="card-text">
              <h4 class="card-title">Add Bulk Rules for VPA Address</h4>
              </div>
            </div>
            <div class="card-body ">
          <div class="container">
            ...
            <div class="row uploadDoc">
              <div class="col-sm-4 ">
             <table id="example" class="csv20" style="display: none;">
                        <thead>
                          <tr class="fw-bold fs-6 text-gray-800">
                            <th>Merchant</th>
                            <td>VPA Address</td>
              ...
              <div class="fileUpload btn btn-orange">
                <img src="../assets/media/images/folder-svg.svg" alt="">
                <span class="upl" id="upload">Upload document</span>
                <form enctype="multipart/form-data" method="post" id="vpaBulkUpload">
                <div style="display:flex">                      <!-- <input type="hidden"   value="IPRULE" name="file1" /> -->

              <!-- <input type="hidden"   value="IPRULE" name="file1" /> -->
              <input type="file" name="file" class="upload up" id="vpaFile"  accept=".xlsx, .xls, .csv" onchange="readURL(this);" />
              <input type="submit" class="btn btn-primary btn-xs"  disabled id="btnBulkUpload" name="btnBulkUpload" onclick="bulkUpload('BLOCK_VPA_ADDRESS','vpaBulkUpload')">
                </div>
            </form>
              ...
              <p>Note: If Always True Flag is checked then Date, Time, Week does not need to be filled</p> but if it is not then all the required fields will have to be filled</p>
