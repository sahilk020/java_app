...
<body id="kt_body"
			...
			<div id="kt_toolbar_container"
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
					...
					<ul
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-dark">Add On</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
							...
							<div class="card-body">
								<div class="row my-3 align-items-center">
									...
									<div class=" col-lg-4 my-2">
										...
										<span id="subscriptionIdError" class="error"></span>
									</div>
									<div class="col-lg-4 my-2">
										<label class="d-flex align-items-center fs-6 fw-bold mb-2">
											<span class="required">Name</span>
										</label>
										<s:textfield id="name" class="form-control form-control-solid"
											name="name" type="text" value="" autocomplete="off"></s:textfield>
								...
								<div class=" row my-3 align-items-center">
									...
									<div class=" col-lg-4 my-2">
										...
										<s:textfield id="type" class="form-control form-control-solid"
											name="type" type="text" value="" autocomplete="off">
										</s:textfield>
									...
									<div class=" col-lg-4 my-2">
										...
										<s:textfield id="unit" class="form-control form-control-solid"
											name="unit" type="text" value="" autocomplete="off">
										</s:textfield>
									...
									<div class=" col-lg-4 my-2">
										...
										<s:textfield id="key" class="form-control form-control-solid"
											name="key" type="text" value="" autocomplete="off">
										</s:textfield>
	...
	<div class=" col-lg-4 my-2">
									...
									<div class=" col-lg-4 my-2">
										...
										<s:textfield id="taxRate"
											class="form-control form-control-solid" name="taxRate"
											type="text" value="" autocomplete="off"></s:textfield>
											<span id="taxRateError" class="error"></span>
									</div>
									<div class=" col-lg-4 my-2">
										<label class="d-flex align-items-center fs-6 fw-bold mb-2">
											<span class="required">Tax Id</span>
										</label>
										<s:textfield id="taxId"
											class="form-control form-control-solid" name="taxId"
											type="text" value="" autocomplete="off">
											
										</s:textfield>
										<span id="taxIdError" class="error"></span>
									</div>
								...
								<div class=" row my-3 align-items-center">
									...
									<div class=" col-lg-4 my-2">
										<label class="d-flex align-items-center fs-6 fw-bold mb-2">
											<span class="required">Tax Group Id</span>
										</label>
										<s:textfield id="taxGroupId"
											class="form-control form-control-solid" name="taxGroupId"
											type="text" value="" autocomplete="off"></s:textfield>
											<span id="taxGroupIdError" class="error"></span>
									</div>

									<div class=" col-lg-4 my-2">
										<label class="d-flex align-items-center fs-6 fw-bold mb-2">
											<span class="required">Create At</span>
									...
									<div class="col-lg-4 my-2">
										<label class="d-flex align-items-center fs-6 fw-bold mb-2">
											<span class="required">Update At</span>
										</label> <span class="svg-icon svg-icon-2 position-absolute mx-4">
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
												xmlns="http://www.w3.org/2000/svg"> <path
												opacity="0.3"
								...
								<div class=" row my-3 align-items-center">
									...
									<div class=" col-lg-4 my-2">
										<label class="d-flex align-items-center fs-6 fw-bold mb-2">
											<span class="required">Invoice Id</span>
										</label>
										<s:textfield id="invoiceId"
											class="form-control form-control-solid" name="invoiceId"
											type="text" value="" autocomplete="off"></s:textfield>
											<span id="invoiceIdError" class="error"></span>
									</div>
													...
													<div class="dropdown1">
														...
														<div class="dropdown-content1">
															<a class="toggle-vis" data-column="0">Merchant</a> <a
																...
																class="toggle-vis" data-column="2">Add On Name</a> <a
																class="toggle-vis" data-column="3">Add On
																Description</a> <a class="toggle-vis" data-column="4">Amount
															</a> <a class="toggle-vis" data-column="5">Currency</a> <a
																class="toggle-vis" data-column="6">Type</a> <a
																class="toggle-vis" data-column="7">Unit</a> <a
																class="toggle-vis" data-column="8">Key</a> <a
																class="toggle-vis" data-column="9">Unit Amount</a> <a
																class="toggle-vis" data-column="10">Tax Indusive</a> <a
																class="toggle-vis" data-column="11">HSN Code</a> <a
																class="toggle-vis" data-column="12">SAC Code</a> <a
																class="toggle-vis" data-column="13">Tax Rate</a> <a
																class="toggle-vis" data-column="14">Tax Id</a> <a
																class="toggle-vis" data-column="15">Tax Group Id</a>
														</div>
													</div>
												</div>
											</div>
		...
		$.ajax({
			...
			success : function(data) {
				...
				for(var i=0;i<response.length;i++){
					 $("#subscriptionId").append("<option value="+response[i].subscriptionId+">"+response[i].subscriptionId+"</option>");
				}
		...
		function save() {
			...
			{
			document.getElementById("subscriptionIdError").innerHTML="Subscription Id is Required";
			valid = false;
			}else{
				document.getElementById("subscriptionIdError").innerHTML="";
			}
			if(!$("#name").val())
			{
			...
			if(!$("#currency").val())
			{
			document.getElementById("currencyError").innerHTML="Currency is Required";
			valid = false;
			}else{
			...
			if(!$("#key").val())
			{
			document.getElementById("keyError").innerHTML="Key is Required";
			valid = false;
			}else{
			...
			if(!$("#taxRate").val())
			{
			document.getElementById("taxRateError").innerHTML="Tax Rate is Required";
			valid = false;
			}else{
				document.getElementById("taxRateError").innerHTML="";
			}
			if(!$("#taxId").val())
			{
			document.getElementById("taxIdError").innerHTML="Tax Id is Required";
			valid = false;
			}else{
				document.getElementById("taxIdError").innerHTML="";
			}
			if(!$("#taxGroupId").val())
			{
			document.getElementById("taxGroupIdError").innerHTML="Tax Group Id is Required";
			valid = false;
			}else{
				document.getElementById("taxGroupIdError").innerHTML="";
			}
			if(!$("#quantity").val())
			{
			...
			if(!$("#invoiceId").val())
			{
			document.getElementById("invoiceIdError").innerHTML="Invoice Id is Required";
			valid = false;
			}else{
				document.getElementById("invoiceIdError").innerHTML="";
			}
						 request={
								    "active":true,
									"id":$("#merchant").val(),
									//"subscription_id":$("#subscriptionId").val(),
									"name":$("#name").val(),
									...
									"created_at":$("#createAt").val(),
									"updated_at":$("#updateAt").val(),
									"hsn_code":$("#hsnCode").val(),
									"sac_code":$("#sacCode").val(),
									"tax_rate":$("#taxRate").val(),
									"tax_id":$("#taxId").val(),
									"tax_group_id":$("#taxGroupId").val(),
									//"status":$("#status").val(),
						 ...
						 var urls = new URL(window.location.href);
					        var domain = urls.origin;
						$.ajax({
							//url : "http://localhost:8080/api/v1/addOns/subscription/"+$("#subscriptionId").val(),
							url:domain+"/siws/api/v1/addOns/subscription/"+$("#subscriptionId").val(),
							type : 'POST',
							headers : {
										'accept': '*/*',
										'Content-Type': 'application/json',
        ...
        var domain = urls.origin;
					 ...
					 $.ajax({
							//url : "http://localhost:8080/api/v1/addOns",
						
							url:domain+"/siws/api/v1/addOns/",
							...
							success : function(data) {
								...
								for (var i = 0; i < res.length; i++) {
									...
									result.push([ res[i].active,res[i].amount, res[i].created_at, res[i].currency,
											res[i].description, res[i].hsn_code,
											res[i].invoice_id, res[i].name,
											res[i].quantity, res[i].sac_code,
											res[i].status, res[i].subscriptionid,
											res[i].tax_group_id, res[i].tax_id,
											res[i].tax_inclusive, res[i].tax_rate,
											res[i].type, res[i].unit,
											res[i].unit_amount,
											res[i].updated_at]);
								}
...
// 						        return '<button type="button" class="btn btn-primary" onclick="Edit(1063510831192553,'+row[0]+')">Primary</button>';
