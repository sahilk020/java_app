...
<head>
        ...
        $(document).ready(function(){
            ...
            $("#submit").click(function(e){
                ...
                $.ajax({type: "POST",
                    ...
                    url : 'merchantResetPasswordAction',

                    data : {
                        token : document.getElementsByName("token")[0].value,
                        merchantPayId : document.getElementById('merchantPayId').value,
                    ...
                    success : function(data){
                        ...
                        if(responsedata){
                            if(responsedata == "Merchant Password has been successfully changed"){
                                document.getElementById("successvalue").innerHTML=data.response;
                                $('#successValues').modal('show');
                                $('#loader').addClass('none');
                                document.getElementById("loadingInner").style.display = "none";
                                //alert(responsedata);
                                fields = "";
                        ...
                        else if(newPassword.value == 0  || confirmNewPassword.value == 0){
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var fields = "#newPassword, #confirmNewPassword";
    ...
    <script>
        function refresh(){
            merchantPayId.value = "Select Merchant";
			  ...
			  <span class="bmd-form-group">
				...
				<div class="input-group">
				  <div class="input-group-prepend">
                     ...
                     <s:select name="merchant" class="form-control" id="merchantPayId"
...
<div class="modal fade" id="successValues" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="enter_otp" id="successvalue"></p>
            </div>
            <div class="modal-footer" id="success_footer">
