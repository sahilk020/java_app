...
function totalAmountofAlltxns(){
		...
		$.ajax({
		    	...
		    	success: function(response){
					...
					td2a.appendChild(document.createTextNode('Success'));
					td3a.appendChild(document.createTextNode(responseObj.totalSaleSuccCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleSuccCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4a.appendChild(document.createTextNode(responseObj.totalSaleSuccAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleSuccAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3b.appendChild(document.createTextNode(responseObj.totalSalePendingCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSalePendingCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4b.appendChild(document.createTextNode(responseObj.totalSalePendingAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSalePendingAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3c.appendChild(document.createTextNode(responseObj.totalSalefailCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSalefailCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4c.appendChild(document.createTextNode(responseObj.totalSalefailAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSalefailAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td2d.appendChild(document.createTextNode('Time Out'));
					td3d.appendChild(document.createTextNode(responseObj.totalSaleTOCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleTOCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4d.appendChild(document.createTextNode(responseObj.totalSaleTOAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleTOAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3e.appendChild(document.createTextNode(responseObj.totalSaleCancelledCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleCancelledCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4e.appendChild(document.createTextNode(responseObj.totalSaleCancelledAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleCancelledAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td2f.appendChild(document.createTextNode('Success'));
					td3f.appendChild(document.createTextNode(responseObj.totalRefundSuccCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRefundSuccCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4f.appendChild(document.createTextNode(responseObj.totalRefundSuccAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRefundSuccAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3g.appendChild(document.createTextNode(responseObj.totalRefundFailCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRefundFailCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4g.appendChild(document.createTextNode(responseObj.totalRefundFailAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRefundFailAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3h.appendChild(document.createTextNode(responseObj.totaltxns.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totaltxns.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4h.appendChild(document.createTextNode(responseObj.totalTxnAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalTxnAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));
					...
					td3a.appendChild(document.createTextNode(responseObj.totalSaleCCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleCCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4a.appendChild(document.createTextNode(responseObj.totalSaleCCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleCCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					tr1.appendChild(td1a);
					tr1.appendChild(td2a);
					tr1.appendChild(td3a);
					tr1.appendChild(td4a);
					...
					td3b.appendChild(document.createTextNode(responseObj.totalSaleDCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleDCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4b.appendChild(document.createTextNode(responseObj.totalSaleDCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleDCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0.00'));					
					tr2.appendChild(td1b);
					tr2.appendChild(td2b);
					tr2.appendChild(td3b);
					tr2.appendChild(td4b);
					...
					td3c.appendChild(document.createTextNode(responseObj.totalSaleNBcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleNBcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4c.appendChild(document.createTextNode(responseObj.totalSaleNBAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleNBAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					tr3.appendChild(td1c);
					tr3.appendChild(td2c);
					tr3.appendChild(td3c);
					tr3.appendChild(td4c);
					...
					td3d.appendChild(document.createTextNode(responseObj.totalSalewalletcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSalewalletcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4d.appendChild(document.createTextNode(responseObj.totalSalewalletAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSalewalletAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0.00'));					
					tr4.appendChild(td1d);
					tr4.appendChild(td2d);
					tr4.appendChild(td3d);
					tr4.appendChild(td4d);
					...
					td3e.appendChild(document.createTextNode(responseObj.totalSaleUPIcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleUPIcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4e.appendChild(document.createTextNode(responseObj.totalSaleUPIAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleUPIAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					tr5.appendChild(td1e);
					tr5.appendChild(td2e);
					tr5.appendChild(td3e);
					tr5.appendChild(td4e);
					...
					td3x.appendChild(document.createTextNode(responseObj.totalSaleCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4x.appendChild(document.createTextNode(responseObj.totalSaleAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSaleAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3f.appendChild(document.createTextNode(responseObj.totalRfCCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfCCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4f.appendChild(document.createTextNode(responseObj.totalRfCCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfCCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					tr6.appendChild(td1f);
					tr6.appendChild(td2f);
					tr6.appendChild(td3f);
					tr6.appendChild(td4f);
					...
					td3g.appendChild(document.createTextNode(responseObj.totalRfDCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfDCcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4g.appendChild(document.createTextNode(responseObj.totalRfDCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfDCAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					tr7.appendChild(td1g);
					tr7.appendChild(td2g);
					tr7.appendChild(td3g);
					tr7.appendChild(td4g);
					...
					td3h.appendChild(document.createTextNode(responseObj.totalRfNBcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfNBcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4h.appendChild(document.createTextNode(responseObj.totalRfNBAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfNBAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0.00'));					
					tr8.appendChild(td1h);
					tr8.appendChild(td2h);
					tr8.appendChild(td3h);
					tr8.appendChild(td4h);
					...
					td3i.appendChild(document.createTextNode(responseObj.totalRfwalletcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfwalletcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4i.appendChild(document.createTextNode(responseObj.totalRfwalletAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfwalletAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3j.appendChild(document.createTextNode(responseObj.totalRfUPIcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfUPIcount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4j.appendChild(document.createTextNode(responseObj.totalRfUPIAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfUPIAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3y.appendChild(document.createTextNode(responseObj.totalRfCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0'));
					td4y.appendChild(document.createTextNode(responseObj.totalRfAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalRfAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));					
					...
					td3k.appendChild(document.createTextNode(responseObj.totalSettleCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSettleCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '0'));
					td4k.appendChild(document.createTextNode(responseObj.totalSettleAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") ? responseObj.totalSettleAmount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")  : '0.00'));
	...
	function popup(txnId , oId , orderId , txnType , pgRefNum) {
		...
		$.ajax({
		    	...
		    	success: function(response){
					...
					$('#sec14 td').eq(1).text(totalRefundamount ? totalRefundamount+".00" : 'Not Available');

					$('#sec16 td').eq(0).text(internalCustip ? internalCustip : 'Not Available');
					$('#sec16 td').eq(1).text(totalSaleamount ? totalSaleamount+".00" : 'Not Available');
                    ...
                    $('#sec11 td').eq(0).text(curAmount ? curAmount : 'Not Available');
