...
@Service
public class MonthlyLineChartService {


	@Autowired
	private BarChartQuery barChartQuery;
	private static Logger logger = LoggerFactory.getLogger(MonthlyLineChartService.class.getName());

	public MonthlyLineChartService() {
	}
	...
	public List<PieChart> preparelist(String payId, String currency, String dateFrom, String dateTo, User user)
		...
		try {
			...
			pieChartsMap = barChartQuery.totalMonthlyTransactionRecord(payId, currency, dateFrom, dateTo,user);
	...
	// TODO In this below method , I need to prepare the Month List 
