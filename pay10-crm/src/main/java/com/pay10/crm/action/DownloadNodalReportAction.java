...
public class DownloadNodalReportAction extends AbstractSecureAction {
	...
	private static Logger logger = LoggerFactory.getLogger(DownloadNodalReportAction.class.getName());
	...
	public String execute() {
		...
		logger.info("List generated successfully for Download Nodal Report , total records = " + transactionList.size());
		...
		logger.info("File generated successfully for Download Nodal Report");
		return SUCCESS;
