...
public class TransactionSearchActionSuperAdmin  extends AbstractSecureAction {
	...
	private static Logger logger = LoggerFactory.getLogger(TransactionSearchActionSuperAdmin.class.getName());
...
private String rrn ;
	...
	public String execute() {
		...
		logger.info("Inside TransactionSearchActionSuperAdmin , execute()");
		...
		try {
			...
			logger.info("Inside TransactionSearchActionSuperAdmin , merchantPayId = " + merchantPayId);
			...
			logger.info("Inside TransactionSearchActionSuperAdmin , bigInt=========== = " + bigInt);
