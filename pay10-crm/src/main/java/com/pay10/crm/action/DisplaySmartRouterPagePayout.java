 ...
 *
 */
public class DisplaySmartRouterPagePayout extends AbstractSecureAction {

	private static final long serialVersionUID = -3054395368649186178L;
	private static Logger logger = LoggerFactory.getLogger(DisplaySmartRouterPagePayout.class.getName());
