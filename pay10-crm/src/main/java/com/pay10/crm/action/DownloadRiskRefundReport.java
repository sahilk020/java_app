...
public class DownloadRiskRefundReport extends AbstractSecureAction{
	...
	public String execute() {
		...
		try {
				...
				logger.info("DownloadRiskRefundReport-------- ");	
				
				List<TransactionSearchNew> aaData = txnReports.riskListReport(acq, payId, dFrom, dTo, 0, 100000);

				logger.info("DownloadRiskRefundReport------------List generated successfully for DownloadRiskRefundReport Report , size = "+aaData.size());
				...
				try {
					...
					filename = "RiskRefundReport" + df.format(new Date()) + FILE_EXTENSION;
					...
					logger.info("File generated successfully for DownloadRiskRefundReport");
