...
public class DownloadSearchPaymentsReportAction extends AbstractSecureAction {

    public static final BigDecimal ONE_HUNDRED = new BigDecimal(100);
    private static final long serialVersionUID = 2871252777725723745L;
    private static Logger logger = LoggerFactory.getLogger(DownloadSearchPaymentsReportAction.class.getName());
    @Autowired
    ...
    public String execute() {
        ...
        if (transactionList.size() < 800000) {
            ...
            for (TransactionSearchDownloadObject transactionSearch : transactionList) {
                ...
                List<Object> objArr = transactionSearch.myCsvMethodDownloadSearchPaymentsReport(splitPaymentSegment,
...
//		}
        ...
        headers.add("Transaction Ref Number");
