...
public class DownloadReportRNSandForceCapture extends AbstractSecureAction {
	...
	public String execute() {
		...
		try {
			...
			List<TransactionSearchNew> aaData = dashboardService.dashboardReport(typeof, 0, 800000);
			...
			try {
				...
				filename = typeof + df.format(new Date()) + FILE_EXTENSION;
