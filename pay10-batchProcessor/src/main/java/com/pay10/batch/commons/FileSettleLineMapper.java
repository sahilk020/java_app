 ...
 */
public class FileSettleLineMapper<T> implements LineMapper<Fields>, InitializingBean {
	
	private static final Logger logger = LoggerFactory.getLogger(FileSettleLineMapper.class);
