...
@Service
public class GeneralSettleValidator implements Validator {
	
	private static Logger logger = Logger.getLogger(GeneralSettleValidator.class
			.getName());
	public final char REPLACEMENT_CHAR = ' ';
	public static final Map<String, FieldType> fieldTypeMap = FieldType.getFieldsMap();

	public GeneralSettleValidator() {
	}
	...
	public void validateRecoRefund(Fields fields) throws SystemException {
		...
		for (String key : fields.keySet()) {
			if(key.equals(FieldType.REFUND_FLAG.getName())) {
				if(fields.get(FieldType.RESPONSE_CODE.getName()).equals("DR")) {
