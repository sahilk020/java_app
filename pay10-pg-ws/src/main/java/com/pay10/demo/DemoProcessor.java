...
@Service("demoProcessor")
public class DemoProcessor implements Processor {

	@Autowired
	private DemoIntegrator demoIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.DEMO.getCode())) {
			return;
		}
		demoIntegrator.process(fields);
	}
