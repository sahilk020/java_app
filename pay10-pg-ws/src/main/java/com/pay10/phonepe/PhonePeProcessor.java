...
@Service("phonepeProcessor")
public class PhonePeProcessor implements Processor {

	@Autowired
	private PhonePeIntegrator phonepeIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.PHONEPE.getCode())) {
			return;
		}
		...
		phonepeIntegrator.process(fields);
