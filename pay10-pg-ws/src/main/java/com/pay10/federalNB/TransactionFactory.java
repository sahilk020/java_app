...
@Service("federalBankNBTransactionFactory")
public class TransactionFactory {
	...
	public Transaction setEnrollment(Fields fields) {
		...
		Transaction transaction = new Transaction();
		System.out.println(fields.get(FieldType.ADF10.getName())+"====FieldType.PG_REF_NUM.getName()================="+fields.get(FieldType.PG_REF_NUM.getName()));
