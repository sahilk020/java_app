...
@Service("paytenProcessor")
public class PaytenProcessor implements Processor {

	
	@Autowired
	private PaytenIntegrator paytenIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.PAY10.getCode())) {
			return;
		}
		...
		paytenIntegrator.process(fields);
