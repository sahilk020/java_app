...
@Service("mobikwikProcessor")
public class MobikwikProcessor implements Processor {

	@Autowired
	private MobikwikIntegrator mobikwikIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.MOBIKWIK.getCode())) {
			return;
		}
		...
		mobikwikIntegrator.process(fields);
