	...
	public void updateResponse(Fields fields) {
		...
		if ((StringUtils.isNotBlank(transaction.getResult()))
			...
			if (StringUtils.isNotBlank(transaction.getResult())) {
				...
				String resultCode = transaction.getResult();
				if (transaction.getResult().contains("IPAY")) {
					resultCode = transaction.getResult().substring(0, 11);
				}
				BobResultType resultInstance = BobResultType.getInstanceFromName(resultCode);
