...
@Service
public class DirecpaySaleResponseHandler {

	private static Logger logger = LoggerFactory.getLogger(DirecpaySaleResponseHandler.class.getName());
	...
	@Autowired
	private DirecpayTransformer direcpayTransformer;
	...
	public Map<String, String> process(Fields fields) throws SystemException {
		...
		direcpayTransformer = new DirecpayTransformer(transactionResponse);
		direcpayTransformer.updateResponse(fields);
