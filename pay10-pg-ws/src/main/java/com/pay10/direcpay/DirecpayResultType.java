...
public enum DirecpayResultType {
	...
	private DirecpayResultType(String bankCode, String iPayCode, String statusCode, String message) {
	...
	public static DirecpayResultType getInstanceFromName(String code) {
		DirecpayResultType[] statusTypes = DirecpayResultType.values();
		for (DirecpayResultType statusType : statusTypes) {
