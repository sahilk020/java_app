...
public class Transaction {
	...
	private String TrantRef;
	private String accNo;
	private String creditTxn;
	...
	public String getTrantRef() {
		return TrantRef;
	}

	public void setTrantRef(String trantRef) {
		TrantRef = trantRef;
	}
	...
	public String getCreditTxn() {
		return creditTxn;
	}

	public void setCreditTxn(String creditTxn) {
