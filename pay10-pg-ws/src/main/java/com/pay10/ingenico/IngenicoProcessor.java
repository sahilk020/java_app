...
@Service("ingenicoProcessor")
public class IngenicoProcessor implements Processor {

	@Autowired
	private IngenicoIntegrator ingenicoIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.INGENICO.getCode())) {
			return;
		}
		...
		ingenicoIntegrator.process(fields);
