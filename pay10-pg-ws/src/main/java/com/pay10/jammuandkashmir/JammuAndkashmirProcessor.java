...
@Service("JammuAndkashmirProcessor")
public class JammuAndkashmirProcessor implements Processor {
	@Autowired
	private JammuAndkashmirIntegrator jammuAndkashmirIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.JAMMU_AND_KASHMIR.getCode())) {
			return;
		}
		...
		String mopType = fields.get(FieldType.MOP_TYPE.getName());
		 ...
		 if (paymentType.equals(PaymentType.NET_BANKING.getCode())) {
			 ...
			 jammuAndkashmirIntegrator.process(fields);
		}
	}
