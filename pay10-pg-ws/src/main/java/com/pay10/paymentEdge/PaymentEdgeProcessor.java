...
@Service("paymentEdgeProcessor")
public class PaymentEdgeProcessor implements Processor {

	@Autowired
	private PayementEdgeIntegrator paymentEdgeIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.PAYMENTAGE.getCode())) {
			return;
		}
		...
		paymentEdgeIntegrator.process(fields);
