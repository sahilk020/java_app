...
@Service("payementEdgeTransactionConverter")
...
//	private static Key keyObj = null;
	...
	public String saleRequest(Fields fields, Transaction transaction) throws SystemException {
		...
		Exception e) {
			logger.error("Exception in generating paymentEdge sale request ", e);
			return null;
		}
		return encData;
	}
	...
	public String refundRequest(Fields fields, Transaction transaction) throws SystemException {
		...
		try {
			...
			logger.info("PaymentEdge refund request  =  " + request.toString());
			...
			logger.error("Exception in generating PaymentEdge refund request", e);
		}
		return requestStr;
