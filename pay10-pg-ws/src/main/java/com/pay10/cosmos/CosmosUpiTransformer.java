...
@Service
public class CosmosUpiTransformer {
	private static Logger logger = LoggerFactory.getLogger(CosmosUpiTransformer.class.getName());

	private Transaction transaction = null;

	public CosmosUpiTransformer(Transaction transaction) {
