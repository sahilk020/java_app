...
@Service("apblProcessor")
public class APBLProcessor implements Processor {

	@Autowired
	private APBLIntegrator apblIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.APBL.getCode())) {
			return;
		}
