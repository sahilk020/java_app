...
@Service
public class AxisBankNBIntegrator {
	...
	@Autowired
	@Qualifier("axisBankNBTransactionCommunicator")
	private TransactionCommunicator communicator;

	@Autowired
	@Qualifier("axisBankNBTransactionFactory")
	...
	public void send(Fields fields) throws SystemException {
		...
		if (txnType.equals(TransactionType.SALE.getName())) {
			...
			String response = communicator.getResponse(request, fields);
			 ...
			 AxisBankNBTransformer  axisBankTransformer = new AxisBankNBTransformer(transactionResponse);
