...
public enum AtomResultType {
	...
	private AtomResultType(String bankCode, String iPayCode, String statusCode, String message) {
	...
	public static AtomResultType getInstanceFromName(String code) {
		AtomResultType[] statusTypes = AtomResultType.values();
		for (AtomResultType statusType : statusTypes) {
