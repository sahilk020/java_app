...
@Service("sbiNBProcessor")
public class SbiNBProcessor implements Processor {

	@Autowired
	private SbiNBIntegrator sbiNBIntegrator;
	...
	public void process(Fields fields) throws SystemException {
		...
		if (!fields.get(FieldType.ACQUIRER_TYPE.getName()).equals(AcquirerType.SBINB.getCode())) {
			return;
		}
		...
		sbiNBIntegrator.process(fields);
