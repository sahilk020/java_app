 ...
 */
@Service
public class AxisMigsIntegrator {
	...
	public void send(Fields fields) throws SystemException {
		...
		if (fields.get(FieldType.TXNTYPE.getName()).equals(TransactionType.ENQUIRY.getName())) {
			Transaction response = transactionConverter.getResponseStatusEnquiry(responseString);
